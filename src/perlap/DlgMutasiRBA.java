...
public class DlgMutasiRBA extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DlgMutasiRBA(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode = new DefaultTableModel(null, new Object[]{
            "Rekening", "Awal", "Masuk", "Keluar", "Akhir",
            "Tanggal", "Tgl Input", "Jam Input", "Petugas", "Status", "Keterangan"
        }) {
            @Override
...
*/
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgMutasiRBA dialog = new DlgMutasiRBA(new javax.swing.JFrame(), true);
    ...
    public void prosesCari() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from rba_perlap where "
                    + "rba_perlap.tgl_pergeseran between ? and ? "
                    + "order by rba_perlap.tgl_input,rba_perlap.jam_input");
            try {
