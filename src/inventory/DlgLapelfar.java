...
public class DlgLapelfar extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DlgLapelfar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        Object[] row = {
            "Nama Barang", "Bentuk Sediaan","Kapasitas", "Stok Awal",
            "Penerimaan", "Ralan", "Ranap", "Total", "Harga", "Total Harga","Kategori"
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Laporan Pelayanan Kefarmasian ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(70, 70, 70))); // NOI18N
...
//            Valid.MyReport("rptKadaluarsaBatch.jrxml", "report", "::[ Kadaluarsa Batch ]::",
...
//        prosesCari();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgLapelfar dialog = new DlgLapelfar(new javax.swing.JFrame(), true);
...
//        System.out.println(theday);
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "(SELECT SUM(jml) FROM detail_pemberian_obat WHERE kode_brng = nama.kode_brng AND tgl_perawatan BETWEEN ? AND ?) AS total,nama.kapasitas,nama.nama "
                    + "FROM (SELECT DISTINCT databarang.nama_brng,databarang.kode_brng,databarang.kode_sat,databarang.ralan,databarang.kapasitas,kategori_barang.nama "
                    + "FROM databarang inner join kategori_barang on databarang.kode_kategori=kategori_barang.kode WHERE databarang.status='1' and databarang.kode_brng "
                    + "IN(SELECT kode_brng FROM detail_pemberian_obat)) AS nama where nama.nama_brng like ? ORDER BY nama.nama_brng ASC");
            try {
//                ps.setString(1, lastweek.toString());
                ...
                ps.setString(6, Valid.SetTgl(tanggal2.getSelectedItem() + ""));
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getDouble(3), rs.getDouble(3) * total,rs.getString("nama")
