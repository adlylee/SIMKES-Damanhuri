...
public final class DlgResepPulang extends javax.swing.JDialog {
    ...
    private double total=0,jumlahtotal=0,tuslah=500;
    ...
    private void initComponents() {
        ...
        ppLembarObatRanap = new javax.swing.JMenuItem();
        ...
        Tkamarpasien = new widget.TextBox();
        jLabel4 = new widget.Label();
        ChkInput = new widget.CekBox();

        Popup.setName("Popup"); // NOI18N

        ppLembarObatRanap.setBackground(new java.awt.Color(255, 255, 254));
        ppLembarObatRanap.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppLembarObatRanap.setForeground(new java.awt.Color(70, 70, 70));
        ppLembarObatRanap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppLembarObatRanap.setText("Lembar Pemberian Obat");
        ppLembarObatRanap.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppLembarObatRanap.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppLembarObatRanap.setIconTextGap(8);
        ppLembarObatRanap.setName("ppLembarObatRanap"); // NOI18N
        ppLembarObatRanap.setPreferredSize(new java.awt.Dimension(225, 25));
        ppLembarObatRanap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppLembarObatRanapActionPerformed(evt);
            }
        });
        Popup.add(ppLembarObatRanap);
        ...
        tbResep.setColumnSelectionAllowed(true);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-02-2020" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-02-2020" }));
        ...
        FormInput.add(TNoRw);
        TNoRw.setBounds(100, 7, 120, 23);

        TPasien.setEditable(false);
        TPasien.setHighlighter(null);
        TPasien.setName("TPasien"); // NOI18N
        FormInput.add(TPasien);
        TPasien.setBounds(220, 7, 351, 23);
        ...
        KdBarang.setBounds(100, 40, 120, 23);
        ...
        Jenisjual.setBounds(610, 7, 110, 23);

        Tkamarpasien.setHighlighter(null);
        Tkamarpasien.setName("Tkamarpasien"); // NOI18N
        Tkamarpasien.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TkamarpasienKeyPressed(evt);
            }
        });
        FormInput.add(Tkamarpasien);
        Tkamarpasien.setBounds(730, 7, 170, 23);

        jLabel4.setText("No.Rawat :");
        jLabel4.setName("jLabel4"); // NOI18N
        FormInput.add(jLabel4);
        jLabel4.setBounds(0, 7, 95, 23);
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void ppLembarObatRanapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppLembarObatRanapActionPerformed
       // if(tabMode.getRowCount()==0){
        //    JOptionPane.showMessageDialog(null,"Maaf, data sudah habis. Tidak ada data yang bisa anda print...!!!!");
        //    TCari.requestFocus();
       // }else 
       //if(tabMode.getRowCount()!=0){
           // this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            Sequel.queryu("delete from temp_resep_pulang");

            for(int i=0;i<tabMode.getRowCount();i++){  
                Sequel.menyimpan("temp_resep_pulang","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",15,new String[]{
                    tabMode.getValueAt(i,3).toString(),tabMode.getValueAt(i,4).toString(),tabMode.getValueAt(i,5).toString(),
            ...
            param.put("total",Sequel.cariIsi("select format(SUM(total+500),0) FROM resep_pulang WHERE no_rawat=?",TNoRw.getText()));
            param.put("peresep",Sequel.cariIsi("select nm_dokter from dpjp_ranap, dokter where dpjp_ranap.kd_dokter=dokter.kd_dokter and no_rawat=?",TNoRw.getText()));
            param.put("kamar",Tkamarpasien.getText());
                

            Valid.MyReport2("rptLembarObatRanap.jrxml","report","::[ Daftar Pemberian Obat Resep Pulang ]::",
                "select temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9, temp10, temp11, temp12, temp13, temp14, temp15 from temp_resep_pulang ",param);
            this.setCursor(Cursor.getDefaultCursor());

      // }
    }//GEN-LAST:event_ppLembarObatRanapActionPerformed

    private void TkamarpasienKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TkamarpasienKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TkamarpasienKeyPressed
    ...
    */
    ...
    private widget.TextBox Tkamarpasien;
    ...
    private javax.swing.JMenuItem ppLembarObatRanap;
    ...
    public void setNoRm(String norwt,Date tgl1,Date tgl2, String kamar_pasien) {
        TNoRw.setText(norwt);
        Sequel.cariIsi("select concat(pasien.no_rkm_medis,' ',pasien.nm_pasien) from reg_periksa inner join pasien "+
                    " on reg_periksa.no_rkm_medis=pasien.no_rkm_medis where no_rawat=? ",TPasien,TNoRw.getText());
        TCari.setText(norwt);     
        ...
        ChkInput.setSelected(true);
        Tkamarpasien.setText(kamar_pasien);
        isForm();
    }
