    ...
    public CariHibahObatBHP(java.awt.Frame parent, boolean modal) {
        ...
        suplier.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(var.getform().equals("CariHibahObatBHP")){
         ...
         try {
            ...
            if(rs.next()){
                ...
                try {            
                    ...
                    while(rs2.next()){
                        if(aktifkanbatch.equals("yes")){
                            Trackobat.catatRiwayat(rs2.getString("kode_brng"),0,rs2.getDouble("jumlah2"),"Hibah",var.getkode(),rs.getString("kd_bangsal"),"Hapus");
                ...
                if(sukses==true){
                    ...
                    jur.simpanJurnal(rs.getString("no_hibah"),Sequel.cariIsi("select current_date()"),"U","BATAL HIBAH OBAT & BHP DI "+Sequel.cariIsi("select nm_bangsal from bangsal where kd_bangsal=?",rs.getString("kd_bangsal")).toUpperCase()+", OLEH "+var.getkode());
                }
