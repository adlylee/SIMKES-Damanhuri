...
public class DlgCariPermintaanLab extends javax.swing.JDialog {
    ...
    public DlgCariPermintaanLab(java.awt.Frame parent, boolean modal) {
        ...
        tbLabIGD.setModel(tabMode5);

        tbLabIGD.setPreferredScrollableViewportSize(new Dimension(800,800));
        tbLabIGD.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (i = 0; i < 12; i++) {
            TableColumn column = tbLabIGD.getColumnModel().getColumn(i);
            if(i==0){
                column.setPreferredWidth(90);
            }else if(i==1){
                column.setPreferredWidth(105);
        ...
        tbLabIGD.setDefaultRenderer(Object.class, new WarnaTable());
        ...
        tbLabIGD2.setModel(tabMode6);

        tbLabIGD2.setPreferredScrollableViewportSize(new Dimension(800,800));
        tbLabIGD2.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (i = 0; i < 16; i++) {
            TableColumn column = tbLabIGD2.getColumnModel().getColumn(i);
            if(i==0){
                column.setPreferredWidth(90);
            }else if(i==1){
                column.setPreferredWidth(105);
        ...
        tbLabIGD2.setDefaultRenderer(Object.class, new WarnaTable());
        ...
        tbLabGabung.setModel(tabMode7);

        tbLabGabung.setPreferredScrollableViewportSize(new Dimension(800,800));
        tbLabGabung.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (i = 0; i < 12; i++) {
            TableColumn column = tbLabGabung.getColumnModel().getColumn(i);
            if(i==0){
                column.setPreferredWidth(90);
            }else if(i==1){
                column.setPreferredWidth(105);
        ...
        tbLabGabung.setDefaultRenderer(Object.class, new WarnaTable());
        ...
        tbLabGabung2.setModel(tabMode8);

        tbLabGabung2.setPreferredScrollableViewportSize(new Dimension(800,800));
        tbLabGabung2.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (i = 0; i < 16; i++) {
            TableColumn column = tbLabGabung2.getColumnModel().getColumn(i);
            if(i==0){
                column.setPreferredWidth(90);
            }else if(i==1){
                column.setPreferredWidth(105);
        ...
        tbLabGabung2.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        TabIGD = new javax.swing.JTabbedPane();
        scrollPane5 = new widget.ScrollPane();
        tbLabIGD = new widget.Table();
        scrollPane6 = new widget.ScrollPane();
        tbLabIGD2 = new widget.Table();
        internalFrame6 = new widget.InternalFrame();
        TabRawatGabung = new javax.swing.JTabbedPane();
        scrollPane7 = new widget.ScrollPane();
        tbLabGabung = new widget.Table();
        scrollPane8 = new widget.ScrollPane();
        tbLabGabung2 = new widget.Table();
        ...
        internalFrame5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Update Waktu Pengambilan Sampel ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("sansserif", 1, 12), new java.awt.Color(70, 70, 70))); // NOI18N
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-11-2023 11:08:39" }));
        ...
        TabIGD.setBackground(new java.awt.Color(255, 255, 254));
        TabIGD.setForeground(new java.awt.Color(70, 70, 70));
        TabIGD.setName("TabIGD"); // NOI18N
        TabIGD.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                TabIGDMouseClicked(evt);
            }
        });
        ...
        tbLabIGD.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        tbLabIGD.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbLabIGD.setComponentPopupMenu(jPopupMenu1);
        tbLabIGD.setName("tbLabIGD"); // NOI18N
        tbLabIGD.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbLabIGDMouseClicked(evt);
            }
        });
        tbLabIGD.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbLabIGDKeyPressed(evt);
            }
        });
        scrollPane5.setViewportView(tbLabIGD);

        TabIGD.addTab("Data Permintaan", scrollPane5);
        ...
        tbLabIGD2.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        tbLabIGD2.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbLabIGD2.setName("tbLabIGD2"); // NOI18N
        tbLabIGD2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbLabIGD2MouseClicked(evt);
            }
        });
        tbLabIGD2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbLabIGD2KeyPressed(evt);
            }
        });
        scrollPane6.setViewportView(tbLabIGD2);

        TabIGD.addTab("Item Permintaan", scrollPane6);

        internalFrame4.add(TabIGD, java.awt.BorderLayout.CENTER);

        TabPilihRawat.addTab("IGD", internalFrame4);

        internalFrame6.setBorder(null);
        internalFrame6.setName("internalFrame6"); // NOI18N
        internalFrame6.setLayout(new java.awt.BorderLayout());

        TabRawatGabung.setBackground(new java.awt.Color(255, 255, 254));
        ...
        tbLabGabung.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        tbLabGabung.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbLabGabung.setComponentPopupMenu(jPopupMenu1);
        tbLabGabung.setName("tbLabGabung"); // NOI18N
        tbLabGabung.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbLabGabungMouseClicked(evt);
            }
        });
        tbLabGabung.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbLabGabungKeyPressed(evt);
            }
        });
        scrollPane7.setViewportView(tbLabGabung);

        TabRawatGabung.addTab("Data Permintaan", scrollPane7);
        ...
        tbLabGabung2.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        tbLabGabung2.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbLabGabung2.setName("tbLabGabung2"); // NOI18N
        tbLabGabung2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbLabGabung2MouseClicked(evt);
            }
        });
        tbLabGabung2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbLabGabung2KeyPressed(evt);
            }
        });
        scrollPane8.setViewportView(tbLabGabung2);

        TabRawatGabung.addTab("Item Permintaan", scrollPane8);

        internalFrame6.add(TabRawatGabung, java.awt.BorderLayout.CENTER);

        TabPilihRawat.addTab("Rawat Gabung", internalFrame6);
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(TabPilihRawat.getSelectedIndex()==0){
            ...
            if(TabIGD.getSelectedIndex()==0){
                if(tabMode5.getRowCount()==0){
                    ...
                    for(i=0;i<row;i++){  
                        tglsampel="";
                        try {
                            tglsampel=tabMode5.getValueAt(i,5).toString();
                        } catch (Exception e) {
                            tglsampel="";
                        }
                        tglhasil="";
                        try {
                            tglhasil=tabMode5.getValueAt(i,7).toString();
                        } catch (Exception e) {
                            tglhasil="";
                        }
                        Sequel.menyimpan("temporary_permintaan_lab","'0','"+
                            tabMode5.getValueAt(i,0).toString()+"','"+
                            ...
                            tabMode5.getValueAt(i,10).toString()+"','"+
                            tabMode5.getValueAt(i,11).toString()+"','','','','','','','','','','','','','','','','','','','','','','','','',''","Periksa Lab"); 
                    }
            ...
            }else if(TabIGD.getSelectedIndex()==1){
                if(tabMode6.getRowCount()==0){
                    ...
                    for(i=0;i<row;i++){  
                        tglsampel="";
                        try {
                            tglsampel=tabMode6.getValueAt(i,9).toString();
                        } catch (Exception e) {
                            tglsampel="";
                        }
                        tglhasil="";
                        try {
                            tglhasil=tabMode6.getValueAt(i,11).toString();
                        } catch (Exception e) {
                            tglhasil="";
                        }
                        Sequel.menyimpan("temporary_permintaan_lab","'0','"+
                                        tabMode6.getValueAt(i,0).toString()+"','"+
                                        ...
                                        tabMode6.getValueAt(i,6).toString()+"','"+
                                        tabMode6.getValueAt(i,7).toString()+"','"+
                                        tabMode6.getValueAt(i,8).toString()+"','"+
                                        tglsampel+"','"+
                                        tabMode6.getValueAt(i,10).toString()+"','"+
                                        tglhasil+"','"+
                                        tabMode6.getValueAt(i,12).toString()+"','"+
                                        tabMode6.getValueAt(i,13).toString()+"','"+
                                        tabMode6.getValueAt(i,14).toString()+"','"+
                                        tabMode6.getValueAt(i,15).toString()+"','','','','','','','','','','','','','','','','','','','','',''","Periksa Lab"); 
                    }
            ...
            if(TabRawatGabung.getSelectedIndex()==0){
                if(tabMode7.getRowCount()==0){
                    ...
                    for(i=0;i<row;i++){  
                        tglsampel="";
                        try {
                            tglsampel=tabMode7.getValueAt(i,5).toString();
                        } catch (Exception e) {
                            tglsampel="";
                        }
                        tglhasil="";
                        try {
                            tglhasil=tabMode7.getValueAt(i,7).toString();
                        } catch (Exception e) {
                            tglhasil="";
                        }
                        Sequel.menyimpan("temporary_permintaan_lab","'0','"+
                            tabMode7.getValueAt(i,0).toString()+"','"+
                            ...
                            tabMode7.getValueAt(i,10).toString()+"','"+
                            tabMode7.getValueAt(i,11).toString()+"','','','','','','','','','','','','','','','','','','','','','','','','',''","Periksa Lab"); 
                    }
                ...
                if(tabMode8.getRowCount()==0){
                    ...
                    for(i=0;i<row;i++){  
                        tglsampel="";
                        try {
                            tglsampel=tabMode8.getValueAt(i,9).toString();
                        } catch (Exception e) {
                            tglsampel="";
                        }
                        tglhasil="";
                        try {
                            tglhasil=tabMode8.getValueAt(i,11).toString();
                        } catch (Exception e) {
                            tglhasil="";
                        }
                        Sequel.menyimpan("temporary_permintaan_lab","'0','"+
                                        tabMode8.getValueAt(i,0).toString()+"','"+
                                        ...
                                        tabMode8.getValueAt(i,6).toString()+"','"+
                                        tabMode8.getValueAt(i,7).toString()+"','"+
                                        tabMode8.getValueAt(i,8).toString()+"','"+
                                        tglsampel+"','"+
                                        tabMode8.getValueAt(i,10).toString()+"','"+
                                        tglhasil+"','"+
                                        tabMode8.getValueAt(i,12).toString()+"','"+
                                        tabMode8.getValueAt(i,13).toString()+"','"+
                                        tabMode8.getValueAt(i,14).toString()+"','"+
                                        tabMode8.getValueAt(i,15).toString()+"','','','','','','','','','','','','','','','','','','','','',''","Periksa Lab"); 
                    }
...
private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
    if(TabPilihRawat.getSelectedIndex()==0){
            ...
            if(!NoRawat.equals("")){
                if(NoPermintaan.trim().equals("")){
                    ...
                    if((Sequel.cariInteger("select count(noorder) from permintaan_pemeriksaan_lab where stts_bayar='Sudah' and noorder=?",NoPermintaan)+
                        ...
                        Sequel.meghapus("diagnosa_pasien_klinis","noorder",NoPermintaan);
                        TeksKosong();
                        tampil();
                    }   
                }
        ...
        if(TabRawatGabung.getSelectedIndex()==0){
            ...
            JOptionPane.showMessageDialog(null,"Hanya bisa dilakukan hapus di Data Permintaan..!!!");
            TabRawatGabung.setSelectedIndex(0);
            TCari.requestFocus();
        } 
    }                
...
private void tbLabRalanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbLabRalanKeyPressed
   if(tabMode.getRowCount()!=0){
    ...
    private void BtnHasilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHasilActionPerformed
        ...
        }if(TabPilihRawat.getSelectedIndex()==2){
            if(TabIGD.getSelectedIndex()==0){
                if(!NoRawat.equals("")){
                    if(NoPermintaan.trim().equals("")){
                        Valid.textKosong(TCari,"No.Permintaan");
        ...
        if(TabPilihRawat.getSelectedIndex()==0){
            ...
            if(!NoRawat.equals("")){
                ...
                if(NoPermintaan.trim().equals("")){
                    ...
                    param.put("tanggal",Valid.SetTgl3(Permintaan));
                    param.put("alamat",Sequel.cariIsi("select concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat from pasien inner join kelurahan inner join kecamatan inner join kabupaten on pasien.kd_kel=kelurahan.kd_kel and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab where no_rkm_medis=? ",norm));
                    param.put("klinis",Sequel.cariIsi("select klinis from diagnosa_pasien_klinis where noorder=? ", tbLabRanap.getValueAt(tbLabRanap.getSelectedRow(),0).toString()));
                    param.put("jns_bayar",Sequel.cariIsi("select penjab.png_jawab from reg_periksa, penjab where reg_periksa.kd_pj=penjab.kd_pj and reg_periksa.no_rawat=? ", tbLabRanap.getValueAt(tbLabRanap.getSelectedRow(),1).toString()));
            ...
            if(!NoRawat.equals("")){
                ...
                if(NoPermintaan.trim().equals("")){
                    ...
                    param.put("tanggal",Valid.SetTgl3(Permintaan));
                    param.put("alamat",Sequel.cariIsi("select concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat from pasien inner join kelurahan inner join kecamatan inner join kabupaten on pasien.kd_kel=kelurahan.kd_kel and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab where no_rkm_medis=? ",norm));
                    param.put("klinis",Sequel.cariIsi("select klinis from diagnosa_pasien_klinis where noorder=? ", tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(),0).toString()));
                    param.put("jns_bayar",Sequel.cariIsi("select penjab.png_jawab from reg_periksa, penjab where reg_periksa.kd_pj=penjab.kd_pj and reg_periksa.no_rawat=? ", tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(),1).toString()));
                    kamar="Poli";
                    namakamar=Sequel.cariIsi("select nm_poli from poliklinik inner join reg_periksa on poliklinik.kd_poli=reg_periksa.kd_poli "+
                        "where reg_periksa.no_rawat=?",NoRawat);
                    param.put("kamar",kamar);
            ...
            if(!NoRawat.equals("")){
                ...
                if(NoPermintaan.trim().equals("")){
                    ...
                    param.put("tanggal",Valid.SetTgl3(Permintaan));
                    param.put("alamat",Sequel.cariIsi("select concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat from pasien inner join kelurahan inner join kecamatan inner join kabupaten on pasien.kd_kel=kelurahan.kd_kel and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab where no_rkm_medis=? ",norm));
                    param.put("klinis",Sequel.cariIsi("select klinis from diagnosa_pasien_klinis where noorder=? ", tbLabGabung.getValueAt(tbLabGabung.getSelectedRow(),0).toString()));
                    param.put("jns_bayar",Sequel.cariIsi("select penjab.png_jawab from reg_periksa, penjab where reg_periksa.kd_pj=penjab.kd_pj and reg_periksa.no_rawat=? ", tbLabGabung.getValueAt(tbLabGabung.getSelectedRow(),1).toString()));
                    kamar=Sequel.cariIsi("select ifnull(kd_kamar,'') from kamar_inap where no_rawat=? order by tgl_masuk desc limit 1",NoRawat);
                    namakamar=kamar+", "+Sequel.cariIsi("select nm_bangsal from bangsal inner join kamar on bangsal.kd_bangsal=kamar.kd_bangsal "+
                        " where kamar.kd_kamar=? ",kamar);
                    kamar="Kamar";
    ...
    private void tbLabIGDMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbLabIGDMouseClicked
    if(tabMode5.getRowCount()!=0){
        try {
            getData3();
        } catch (java.lang.NullPointerException e) {
    ...
    }//GEN-LAST:event_tbLabIGDMouseClicked

    private void tbLabIGDKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbLabIGDKeyPressed
   if(tabMode5.getRowCount()!=0){
            if((evt.getKeyCode()==KeyEvent.VK_ENTER)||(evt.getKeyCode()==KeyEvent.VK_UP)||(evt.getKeyCode()==KeyEvent.VK_DOWN)){
                try {
                    getData3();
    ...
    }//GEN-LAST:event_tbLabIGDKeyPressed

    private void tbLabIGD2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbLabIGD2MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_tbLabIGD2MouseClicked

    private void tbLabIGD2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbLabIGD2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tbLabIGD2KeyPressed

    private void TabIGDMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabIGDMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_TabIGDMouseClicked

    private void tbLabGabungMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbLabGabungMouseClicked
        if (tabMode7.getRowCount() != 0) {
            try {
                getData4();
            } catch (java.lang.NullPointerException e) {
    ...
    }//GEN-LAST:event_tbLabGabungMouseClicked

    private void tbLabGabungKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbLabGabungKeyPressed
        if(tabMode7.getRowCount()!=0){
            if((evt.getKeyCode()==KeyEvent.VK_ENTER)||(evt.getKeyCode()==KeyEvent.VK_UP)||(evt.getKeyCode()==KeyEvent.VK_DOWN)){
                try {
                    getData4();
    ...
    }//GEN-LAST:event_tbLabGabungKeyPressed

    private void tbLabGabung2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbLabGabung2MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_tbLabGabung2MouseClicked

    private void tbLabGabung2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbLabGabung2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tbLabGabung2KeyPressed
    ...
    */
    ...
    private javax.swing.JTabbedPane TabIGD;
    ...
    private widget.Table tbLabGabung;
    private widget.Table tbLabGabung2;
    private widget.Table tbLabIGD;
    private widget.Table tbLabIGD2;
    ...
    private void getData3() {
        if(tbLabIGD.getSelectedRow()!= -1){
            NoPermintaan=tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(),0).toString();
            NoRawat=tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(),1).toString();
            Pasien=tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(),2).toString();
            Permintaan=tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(),3).toString();
            JamPermintaan=tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(),4).toString();
            Sampel=tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(),5).toString();
            JamSampel=tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(),6).toString();
            Hasil=tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(),7).toString();
            JamHasil=tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(),8).toString();
            KodeDokter=tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(),9).toString();
            DokterPerujuk=tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(),10).toString();
            Ruang=tbLabIGD.getValueAt(tbLabIGD.getSelectedRow(),11).toString();
        }
    }
...
//        MnCetakHasilLab.setEnabled(var.getpermintaan_lab());
     ...
     private void tampil5() {
        ...
        try {
            ps=koneksi.prepareStatement(
                    ...
                    "dokter.nm_dokter like ?) order by "+
                    "permintaan_lab.tgl_permintaan,permintaan_lab.jam_permintaan desc");
            try {
                ps.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                ps.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
    ...
    private void tampil7() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "if(permintaan_lab.tgl_sampel='0000-00-00','',permintaan_lab.tgl_sampel) as tgl_sampel,if(permintaan_lab.jam_sampel='00:00:00','',permintaan_lab.jam_sampel) as jam_sampel,"
                    + "if(permintaan_lab.tgl_hasil='0000-00-00','',permintaan_lab.tgl_hasil) as tgl_hasil,if(permintaan_lab.jam_hasil='00:00:00','',permintaan_lab.jam_hasil) as jam_hasil,"
                    + "permintaan_lab.dokter_perujuk,dokter.nm_dokter,bangsal.nm_bangsal from permintaan_lab, ranap_gabung,reg_periksa,pasien,dokter,kamar_inap,kamar, bangsal "
                    + "where ranap_gabung.no_rawat2=permintaan_lab.no_rawat and permintaan_lab.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    + "and permintaan_lab.dokter_perujuk=dokter.kd_dokter and ranap_gabung.no_rawat=kamar_inap.no_rawat and kamar_inap.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal and "
                    + "permintaan_lab.status='ranap' and kamar_inap.stts_pulang <> 'Pindah Kamar' and permintaan_lab.tgl_permintaan between ? and ? and (permintaan_lab.noorder like ? or "
                    + "permintaan_lab.no_rawat like ? or reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or dokter.nm_dokter like ?) "
                    + "group by permintaan_lab.noorder order by permintaan_lab.status='ranap' and permintaan_lab.tgl_permintaan,permintaan_lab.jam_permintaan desc");
            try {
                ps.setString(1, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                ps.setString(2, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
    ...
    private void tampil8() {
        ...
        try {
            ps=koneksi.prepareStatement(
                    ...
                    "if(permintaan_lab.jam_permintaan='00:00:00','',permintaan_lab.jam_permintaan) as jam_permintaan,permintaan_lab.tgl_sampel,"+
                    "if(permintaan_lab.jam_sampel='00:00:00','',permintaan_lab.jam_sampel) as jam_sampel, permintaan_lab.tgl_hasil,"+
                    "if(permintaan_lab.jam_hasil='00:00:00','',permintaan_lab.jam_hasil) as jam_hasil, permintaan_lab.dokter_perujuk,dokter.nm_dokter,bangsal.nm_bangsal "
                    + "from permintaan_lab inner join ranap_gabung inner join reg_periksa inner join pasien inner join permintaan_pemeriksaan_lab inner join permintaan_detail_permintaan_lab inner join jns_perawatan_lab inner join template_laboratorium "
                    + "inner join dokter inner join kamar_inap inner join kamar inner join bangsal "
                    + "on ranap_gabung.no_rawat2=permintaan_lab.no_rawat and permintaan_lab.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and permintaan_lab.noorder=permintaan_pemeriksaan_lab.noorder "
                    + "and permintaan_lab.noorder=permintaan_detail_permintaan_lab.noorder and permintaan_pemeriksaan_lab.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw and permintaan_detail_permintaan_lab.id_template=template_laboratorium.id_template "
                    + "and ranap_gabung.no_rawat=kamar_inap.no_rawat and kamar_inap.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal "
                    + "where permintaan_lab.status='ranap' and kamar_inap.stts_pulang <> 'Pindah Kamar' and permintaan_lab.tgl_permintaan between ? and ? and (permintaan_lab.noorder like ? or "
                    + "permintaan_lab.no_rawat like ? or reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or  jns_perawatan_lab.nm_perawatan like ? or  template_laboratorium.Pemeriksaan like ? or "+
                    " dokter.nm_dokter like ?) group by permintaan_lab.noorder order by permintaan_lab.tgl_permintaan,permintaan_lab.jam_permintaan desc");
            try {
                ps.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                ps.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                ps.setString(3,"%"+TCari.getText()+"%");
    ...
    private void getData4() {
        if (tbLabGabung.getSelectedRow() != -1) {
            NoPermintaan = tbLabGabung.getValueAt(tbLabGabung.getSelectedRow(), 0).toString();
            NoRawat = tbLabGabung.getValueAt(tbLabGabung.getSelectedRow(), 1).toString();
            Pasien = tbLabGabung.getValueAt(tbLabGabung.getSelectedRow(), 2).toString();
            Permintaan = tbLabGabung.getValueAt(tbLabGabung.getSelectedRow(), 3).toString();
            JamPermintaan = tbLabGabung.getValueAt(tbLabGabung.getSelectedRow(), 4).toString();
            Sampel = tbLabGabung.getValueAt(tbLabGabung.getSelectedRow(), 5).toString();
            JamSampel = tbLabGabung.getValueAt(tbLabGabung.getSelectedRow(), 6).toString();
            Hasil = tbLabGabung.getValueAt(tbLabGabung.getSelectedRow(), 7).toString();
            JamHasil = tbLabGabung.getValueAt(tbLabGabung.getSelectedRow(), 8).toString();
            KodeDokter = tbLabGabung.getValueAt(tbLabGabung.getSelectedRow(), 9).toString();
            DokterPerujuk = tbLabGabung.getValueAt(tbLabGabung.getSelectedRow(), 10).toString();
            Ruang = tbLabGabung.getValueAt(tbLabGabung.getSelectedRow(), 11).toString();
        }
    }    
}
