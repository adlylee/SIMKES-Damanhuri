...
public final class DlgPermintaanLaboratorium extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(560, 275));
        ...
        TPasien.setBounds(340, 10, 440, 23);

        jLabel11.setText("Klinis :");
        jLabel11.setName("jLabel11"); // NOI18N
        PanelInput.add(jLabel11);
        jLabel11.setBounds(0, 70, 92, 23);
        ...
        BtnCari1.setBounds(510, 100, 28, 23);
        ...
        Scroll1.setBounds(100, 130, 677, 110);
        ...
        TNoPermintaan.setBounds(650, 100, 130, 23);
        ...
        PanelInput.add(TKlinis);
        TKlinis.setBounds(95, 70, 690, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            if(jmlparsial>0){    
                simpan(); 
                //Sequel.menyimpan("diagnosa_pasien_klinis, '"++"'");
                //Sequel.menyi
                //tambahan kodingan alridho klinis
              /*  try {
                    String klinis;
                    klinis = "INSERT INTO diagnosa_pasien_klinis VALUES ('"+TNoPermintaan.getText()+"','"+TKlinis.getText()+"')";
                    PreparedStatement pst_klinis_lab;          
                    pst_klinis_lab = koneksiDB.condb().prepareStatement(klinis);
                    pst_klinis_lab.execute(); 
                    JOptionPane.showMessageDialog(rootPane,"Pian telah berhasil menyimpan paket KLINIS..");
...
private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
    ...
    */
    ...
    private void isRawat(){
        ...
        Sequel.cariIsi("select kd_dokter from dpjp_ranap where no_rawat=? ",KodePerujuk,TNoRw.getText());
    ...
    private void isForm(){
        if(ChkInput.isSelected()==true){
            ...
            FormInput.setPreferredSize(new Dimension(WIDTH,239));
        ...
        try{
            ...
            if(cara_bayar_lab.equals("Yes")&&kelas_lab.equals("No")){
                pstindakan=koneksi.prepareStatement(
                    ...
                    "jns_perawatan_lab.kd_jenis_prw not in ('J000018','J000019','J000020','J000021','J000023','J000024','J000025','J000038','J000051','J000054',"
//                            + "'J000058',"
                            + "'J000062','J000063','J000064','J000069','J000070','J000078','J000082','J000084','J000167','J000179') and SUBSTRING(jns_perawatan_lab.nm_perawatan,1,6) !='(Cito)' and jns_perawatan_lab.total_byr !='0' and jns_perawatan_lab.status='1' and (jns_perawatan_lab.kd_pj=? or jns_perawatan_lab.kd_pj='-') and jns_perawatan_lab.status='1' and jns_perawatan_lab.kd_jenis_prw like ? or "+
                    "jns_perawatan_lab.kd_jenis_prw not in ('J000018','J000019','J000020','J000021','J000023','J000024','J000025','J000038','J000051','J000054',"
//                            + "'J000058',"
                            + "'J000062','J000063','J000064','J000069','J000070','J000078','J000082','J000084','J000167','J000179') and SUBSTRING(jns_perawatan_lab.nm_perawatan,1,6) !='(Cito)' and jns_perawatan_lab.total_byr !='0' and jns_perawatan_lab.status='1' and (jns_perawatan_lab.kd_pj=? or jns_perawatan_lab.kd_pj='-') and jns_perawatan_lab.status='1' and jns_perawatan_lab.nm_perawatan like ? "+
                ...
                pstindakan2=koneksi.prepareStatement(
                    ...
                    "jns_perawatan_lab.kd_jenis_prw not in ('J000018','J000019','J000020','J000021','J000023','J000024','J000025','J000038','J000051','J000054',"
//                            + "'J000058',"
                            + "'J000062','J000063','J000064','J000069','J000070','J000078','J000082','J000084','J000167','J000179') and SUBSTRING(jns_perawatan_lab.nm_perawatan,1,6) !='(Cito)' and jns_perawatan_lab.total_byr !='0' and jns_perawatan_lab.status='1' and jns_perawatan_lab.status='1' and jns_perawatan_lab.kd_jenis_prw like ? or "+
                    "jns_perawatan_lab.kd_jenis_prw not in ('J000018','J000019','J000020','J000021','J000023','J000024','J000025','J000038','J000051','J000054',"
//                            + "'J000058',"
                            + "'J000062','J000063','J000064','J000069','J000070','J000078','J000082','J000084','J000167','J000179') and SUBSTRING(jns_perawatan_lab.nm_perawatan,1,6) !='(Cito)' and jns_perawatan_lab.total_byr !='0' and jns_perawatan_lab.status='1' and jns_perawatan_lab.status='1' and jns_perawatan_lab.nm_perawatan like ?  "+
                    "order by jns_perawatan_lab.kd_jenis_prw"); 
                ...
                pstindakan3=koneksi.prepareStatement(
                    ...
                    "jns_perawatan_lab.kd_jenis_prw not in ('J000018','J000019','J000020','J000021','J000023','J000024','J000025','J000038','J000051','J000054',"
//                            + "'J000058',"
                            + "'J000062','J000063','J000064','J000069','J000070','J000078','J000082','J000084','J000167','J000179') and SUBSTRING(jns_perawatan_lab.nm_perawatan,1,6) !='(Cito)' and jns_perawatan_lab.total_byr !='0' and jns_perawatan_lab.status='1' and (jns_perawatan_lab.kd_pj=? or jns_perawatan_lab.kd_pj='-') and (jns_perawatan_lab.kelas=? or jns_perawatan_lab.kelas='-') and jns_perawatan_lab.status='1' and jns_perawatan_lab.kd_jenis_prw like ? or "+
                    "jns_perawatan_lab.kd_jenis_prw not in ('J000018','J000019','J000020','J000021','J000023','J000024','J000025','J000038','J000051','J000054',"
//                            + "'J000058',"
                            + "'J000062','J000063','J000064','J000069','J000070','J000078','J000082','J000084','J000167','J000179') and SUBSTRING(jns_perawatan_lab.nm_perawatan,1,6) !='(Cito)' and jns_perawatan_lab.total_byr !='0' and jns_perawatan_lab.status='1' and (jns_perawatan_lab.kd_pj=? or jns_perawatan_lab.kd_pj='-') and (jns_perawatan_lab.kelas=? or jns_perawatan_lab.kelas='-') and jns_perawatan_lab.status='1' and jns_perawatan_lab.nm_perawatan like ? "+
                    "order by jns_perawatan_lab.kd_jenis_prw");
                ...
                pstindakan4=koneksi.prepareStatement(
                    ...
                    "jns_perawatan_lab.kd_jenis_prw not in ('J000018','J000019','J000020','J000021','J000023','J000024','J000025','J000038','J000051','J000054',"
//                            + "'J000058',"
                            + "'J000062','J000063','J000064','J000069','J000070','J000078','J000082','J000084','J000167','J000179') and SUBSTRING(jns_perawatan_lab.nm_perawatan,1,6) !='(Cito)' and jns_perawatan_lab.total_byr !='0' and jns_perawatan_lab.status='1' and (jns_perawatan_lab.kelas=? or jns_perawatan_lab.kelas='-') and jns_perawatan_lab.status='1' and jns_perawatan_lab.kd_jenis_prw like ? or "+
                    "jns_perawatan_lab.kd_jenis_prw not in ('J000018','J000019','J000020','J000021','J000023','J000024','J000025','J000038','J000051','J000054',"
//                            + "'J000058',"
                            + "'J000062','J000063','J000064','J000069','J000070','J000078','J000082','J000084','J000167','J000179') and SUBSTRING(jns_perawatan_lab.nm_perawatan,1,6) !='(Cito)' and jns_perawatan_lab.total_byr !='0' and jns_perawatan_lab.status='1' and (jns_perawatan_lab.kelas=? or jns_perawatan_lab.kelas='-') and jns_perawatan_lab.status='1' and jns_perawatan_lab.nm_perawatan like ?  "+
                    "order by jns_perawatan_lab.kd_jenis_prw"); 
            } 
    ...
    public void setDokterPerujuk(String kodeperujuk){
        KodePerujuk.setText(kodeperujuk);
        NmPerujuk.setText(Sequel.cariIsi("SELECT nm_dokter FROM dokter WHERE kd_dokter = ?",kodeperujuk));
    }
    ...
    private void simpan() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            ...
            try {                    
                ...
                Sequel.menyimpan2("diagnosa_pasien_klinis","?,?",2,new String[]{TNoPermintaan.getText(),TKlinis.getText()});
                ...
                //    String klinis;
                     //"INSERT INTO diagnosa_pasien_klinis VALUES ('"+TNoPermintaan.getText()+"','"+TKlinis.getText()+"')";
                //    klinis = "INSERT INTO diagnosa_pasien_klinis VALUES ('"+TNoPermintaan.getText().toString()+"','"+TKlinis.getText().toString()+"')";
                //    PreparedStatement pst_klinis_lab;          
                //    pst_klinis_lab = koneksiDB.condb().prepareStatement(klinis);
                //    pst_klinis_lab.execute(); 
                //    JOptionPane.showMessageDialog(rootPane,"Pian telah berhasil menyimpan paket KLINIS..");
