...
public class DlgCariPermintaanRadiologi extends javax.swing.JDialog {
    ...
    public DlgCariPermintaanRadiologi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Permintaan","No.Rawat","Pasien","Jns. Bayar","Permintaan","Jam",
            "Sampel","Jam","Hasil","Jam","Kode Dokter","Dokter Perujuk","Poli Registrasi","Klinis"
            }){
        ...
        tabMode2=new DefaultTableModel(null,new Object[]{
                "No.Permintaan","No.Rawat","Pasien","Jns. Bayar","Pemeriksaan","Permintaan",
        ...
        tabMode3=new DefaultTableModel(null,new Object[]{
            "No.Permintaan","No.Rawat","Pasien","Jns. Bayar","Permintaan","Jam",
            "Sampel","Jam","Hasil","Jam","Kode Dokter","Dokter Perujuk","Kamar Terakhir","Klinis"
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
    ...
    private void initComponents() {
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-01-2023 12:34:53" }));
        ...
        if(TabPilihRawat.getSelectedIndex()==0){
            if(TabRawatJalan.getSelectedIndex()==0){
                if(tabMode.getRowCount()==0){
                    ...
                    Valid.MyReport("rptLapPermintaanRadiologi.jrxml","report","::[ Data Permintaan Radiologi ]::",
                ...
                if(tabMode2.getRowCount()==0){
                    ...
                    param.put("emailrs",var.getemailrs());
                    param.put("logo",Sequel.cariGambar("select logo from setting")); 
                    Valid.MyReport("rptLapPermintaanRadiologi2.jrxml","report","::[ Data Detail Permintaan Radiologi ]::",
                        "select no, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9, temp10, temp11, temp12, temp13, temp14, temp14, temp15, temp16 from temporary_permintaan_radiologi order by no asc",param);
                }
            }            
        }else if(TabPilihRawat.getSelectedIndex()==1){
            if(TabRawatInap.getSelectedIndex()==0){
                if(tabMode3.getRowCount()==0){
                    ...
                    param.put("emailrs",var.getemailrs());
                    param.put("logo",Sequel.cariGambar("select logo from setting")); 
                    Valid.MyReport("rptLapPermintaanRadiologi3.jrxml","report","::[ Data Permintaan Radiologi ]::",
                        "select no, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9, temp10, temp11, temp12, temp13, temp14, temp14, temp15, temp16 from temporary_permintaan_radiologi order by no asc",param);
                }
                ...
                if(tabMode4.getRowCount()==0){
                    ...
                    param.put("emailrs",var.getemailrs());
                    param.put("logo",Sequel.cariGambar("select logo from setting")); 
                    Valid.MyReport("rptLapPermintaanRadiologi4.jrxml","report","::[ Data Detail Permintaan Radiologi ]::",
                        "select no, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9, temp10, temp11, temp12, temp13, temp14, temp14, temp15, temp16 from temporary_permintaan_radiologi order by no asc",param);
                }
            }            
        }            
            ...
            if(tbRadiologiRalan.getSelectedRow()!= -1){
                if(tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString().trim().equals("")){
                    ...
                    if(Sequel.cariInteger("select count(noorder) from permintaan_pemeriksaan_radiologi where stts_bayar='Sudah' and noorder=?",tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString())>0){
                        ...
                        Sequel.meghapus("diagnosa_pasien_klinis","noorder",tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString());
                        tampil();
                    }                    
                }
            }else{            
            ...
            if(tbRadiologiRanap.getSelectedRow()!= -1){
                if(tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),0).toString().trim().equals("")){
                    ...
                    if(Sequel.cariInteger("select count(noorder) from permintaan_pemeriksaan_radiologi where stts_bayar='Sudah' and noorder=?",tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),0).toString())>0){
                        ...
                        Sequel.meghapus("diagnosa_pasien_klinis","noorder",tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),0).toString());
                        tampil3();
                    }                    
                }
            }else{            
        ...
        if(TabPilihRawat.getSelectedIndex()==0){
            if(tbRadiologiRalan.getSelectedRow()!= -1){
                ...
                if(tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString().trim().equals("")){
                    ...
                    param.put("pengirim",Sequel.cariIsi("select dokter.nm_dokter from reg_periksa, dokter where reg_periksa.kd_dokter=dokter.kd_dokter and reg_periksa.no_rawat=? ", tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),1).toString()));//tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),10).toString());
                    param.put("tanggal",Valid.SetTgl3(tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),4).toString()));
                    ...
                    param.put("jam",tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),5).toString());
                    param.put("namars",var.getnamars());
                    param.put("alamatrs",var.getalamatrs());
                    param.put("kotars",var.getkabupatenrs());
                    param.put("propinsirs",var.getpropinsirs());
            ...
            if(tbRadiologiRanap.getSelectedRow()!= -1){
                ...
                if(tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),0).toString().trim().equals("")){
                   ...
                   // param.put("pengirim",tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),10).toString());
                    param.put("pengirim",tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),11).toString());//Sequel.cariIsi("select dokter.nm_dokter from reg_periksa, dokter where reg_periksa.kd_dokter=dokter.kd_dokter and reg_periksa.no_rawat=? ", tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),12).toString()));
                    param.put("tanggal",Valid.SetTgl3(tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),4).toString()));
                    param.put("alamat",Sequel.cariIsi("select concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat from pasien inner join kelurahan inner join kecamatan inner join kabupaten on pasien.kd_kel=kelurahan.kd_kel and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab where no_rkm_medis=? ",norm));
                    param.put("diagnosa1",Sequel.cariIsi("select penyakit.nm_penyakit from diagnosa_pasien, penyakit where diagnosa_pasien.kd_penyakit = penyakit.kd_penyakit and diagnosa_pasien.no_rawat=? order by diagnosa_pasien.prioritas asc limit 1", tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),1).toString()));
                    param.put("jns_bayar",tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),3).toString());
                    param.put("klinis",Sequel.cariIsi("select klinis from diagnosa_pasien_klinis where noorder=? ", tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),0).toString()));  
                    ...
                    param.put("namakamar",namakamar);
                    param.put("diagnosa",diagnosa);
                    param.put("jam",tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),5).toString());
                    param.put("namars",var.getnamars());
                    param.put("alamatrs",var.getalamatrs());
                    param.put("kotars",var.getkabupatenrs());
                    param.put("propinsirs",var.getpropinsirs());
    ...
    private void tampil() {
        ...
        try {
            ps=koneksi.prepareStatement(
                    "select permintaan_radiologi.noorder,permintaan_radiologi.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,penjab.png_jawab,permintaan_radiologi.tgl_permintaan,"+
                    ...
                    "permintaan_radiologi.dokter_perujuk,dokter.nm_dokter,poliklinik.nm_poli,diagnosa_pasien_klinis.klinis from permintaan_radiologi inner join reg_periksa "+
                    "inner join pasien inner join dokter inner join poliklinik inner join penjab on permintaan_radiologi.no_rawat=reg_periksa.no_rawat and "+
                    "reg_periksa.no_rkm_medis=pasien.no_rkm_medis and permintaan_radiologi.dokter_perujuk=dokter.kd_dokter and reg_periksa.kd_poli=poliklinik.kd_poli and penjab.kd_pj=reg_periksa.kd_pj "+
                    "left join diagnosa_pasien_klinis on diagnosa_pasien_klinis.noorder=permintaan_radiologi.noorder where "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("jam_hasil"),rs.getString("dokter_perujuk"),rs.getString("nm_dokter"),rs.getString("nm_poli"),rs.getString("klinis")
                    });                    
                    ps2=koneksi.prepareStatement(
                            "select permintaan_pemeriksaan_radiologi.kd_jenis_prw,jns_perawatan_radiologi.nm_perawatan "+
                            "from permintaan_pemeriksaan_radiologi inner join jns_perawatan_radiologi on "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode2.addRow(new String[]{
                        ...
                        rs.getString("nm_perawatan"),rs.getString("png_jawab"),rs.getString("tgl_permintaan"),rs.getString("jam_permintaan"),
                        rs.getString("tgl_sampel"),rs.getString("jam_sampel"),rs.getString("tgl_hasil"),
    ...
    private void tampil3() {
        ...
        try {
            ps=koneksi.prepareStatement(
                    ...
                    "if(permintaan_radiologi.tgl_sampel='0000-00-00','',permintaan_radiologi.tgl_sampel) as tgl_sampel,if(permintaan_radiologi.jam_sampel='00:00:00','',permintaan_radiologi.jam_sampel) as jam_sampel,"+
                    "permintaan_radiologi.tgl_hasil,if(permintaan_radiologi.jam_hasil='00:00:00','',permintaan_radiologi.jam_hasil) as jam_hasil,"+
                    "permintaan_radiologi.dokter_perujuk,dokter.nm_dokter,bangsal.nm_bangsal,diagnosa_pasien_klinis.klinis from permintaan_radiologi inner join reg_periksa "+
                    "inner join pasien inner join dokter inner join bangsal inner join kamar inner join kamar_inap inner join penjab on permintaan_radiologi.no_rawat=reg_periksa.no_rawat and "+
                    ...
                    "and reg_periksa.no_rawat=kamar_inap.no_rawat and kamar_inap.kd_kamar=kamar.kd_kamar and penjab.kd_pj=reg_periksa.kd_pj "+
                    "left join diagnosa_pasien_klinis on diagnosa_pasien_klinis.noorder=permintaan_radiologi.noorder where "+
