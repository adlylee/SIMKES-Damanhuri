...
private void NmKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NmKeyPressed
    ...
    */
    ...
    public void tampil3() {
        ...
        try{
            ps=koneksi.prepareStatement("select kd_rek, nm_rek, tipe, balance "+
                    " from rekening where level='0' and balance='K' and kd_rek like '5%' and "+
                    " (nm_rek like ? or "+
                    " tipe like ? or "+
            ...
            try {            
                ...
                while(rs.next()){
                    ...
                    ps2=koneksi.prepareStatement("select rekening.kd_rek, rekening.nm_rek, rekening.tipe, rekening.balance "+
                        " from rekening inner join subrekening on rekening.kd_rek=subrekening.kd_rek2 "+
                        " where subrekening.kd_rek=? and rekening.level='1' and rekening.balance='K' and rekening.kd_rek like ? or "+
                        " subrekening.kd_rek=? and rekening.level='1' and rekening.balance='K' and rekening.nm_rek like ? or "+
                        " subrekening.kd_rek=? and rekening.level='1' and rekening.balance='K' and rekening.tipe like ? order by rekening.kd_rek");
                    try {
                        ps2.setString(1,rs.getString(1));
                        ps2.setString(2,"%"+TCari.getText().trim()+"%");
                        ps2.setString(3,rs.getString(1));
