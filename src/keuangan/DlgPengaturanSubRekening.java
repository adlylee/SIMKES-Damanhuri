...
import fungsi.var;
import ipsrs.DlgCariJenisIPSRS;
 ...
 * @author dosen
 */
public final class DlgPengaturanSubRekening extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPengaturanSubRekening(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(628,674);

        Object[] row={"Nama Akun",
                      "Kode Rekening",
    ...
    private void initComponents() {
        ...
        nmjenis.setBounds(132, 40, 203, 23);
        ...
        btnJenis.setBounds(340, 40, 25, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(kdjenis.getText().trim().equals("")){
            Valid.textKosong(kdjenis,"Jenis");
        }else{
            String insert = "'"+Nm.getText()+"','"+Kd.getText()+"','"+kdjenis.getText()+"',CONCAT(CURRENT_DATE(),' ',CURRENT_TIME()),1";
            Sequel.menyimpan("set_akun_sub_akun (nama_akun,kode_akun,kode_mapping,created_at,status)", insert);
            BtnCariActionPerformed(evt);
            emptTeks();
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPengaturanSubRekening dialog = new DlgPengaturanSubRekening(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try{       
            ps=koneksi.prepareStatement("select * from set_akun_sub_akun ");
            try {
                rs=ps.executeQuery();
                while(rs.next()){    
