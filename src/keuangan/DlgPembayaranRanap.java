...
public final class DlgPembayaranRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        LCount.setPreferredSize(new java.awt.Dimension(240, 23));
    ...
    public void tampil(){
        ...
        try{      
            ps= koneksi.prepareStatement(
                ...
                "where kamar_inap.tgl_keluar between ? and ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and COALESCE(dpjp_ranap.kd_dokter,'') like ? and concat(kamar.kd_bangsal,bangsal.nm_bangsal) like ? and reg_periksa.no_rkm_medis like ? and kamar_inap.stts_pulang not in ('-','Pindah Kamar') and "+
