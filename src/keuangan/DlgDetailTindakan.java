...
public final class DlgDetailTindakan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        panelGlass5.add(label40);

        KdCaraBayarRad.setEditable(false);
        KdCaraBayarRad.setName("KdCaraBayar"); // NOI18N
        KdCaraBayarRad.setPreferredSize(new java.awt.Dimension(50, 23));
        panelGlass5.add(KdCaraBayarRad);

        NmCaraBayarRad.setEditable(false);
        NmCaraBayarRad.setName("NmCaraBayarRad"); // NOI18N
        NmCaraBayarRad.setPreferredSize(new java.awt.Dimension(130, 23));
        panelGlass5.add(NmCaraBayarRad);
        ...
        panelGlass5.add(BtnCaraBayarRad);
        ...
        switch (TabRawat.getSelectedIndex()) {
            ...
            case 6:
                if(tabModeRanapDokterParamedis.getRowCount()==0){
                    ...
                    param.put("cari","%"+TCari.getText().trim()+"%");                    
                    param.put("logo",Sequel.cariGambar("select logo from setting"));
                    Valid.MyReport("rptDetailTindakanRanapDokterParamedis.jrxml",param,"::[ Detail Tindakan Ranap Yang Ditangani Dokter & Paramedis ]::");                    
                }   break;
            case 7:
                if(tabModeRadiologi.getRowCount()==0){
                    ...
                    param.put("cari","%"+TCari.getText().trim()+"%");                    
                    param.put("logo",Sequel.cariGambar("select logo from setting"));
                    Valid.MyReport("rptDetailRadiologi.jrxml",param,"::[ Detail Pemeriksaan Radiologi ]::");                    
                }   break;
            case 8:
                if(tabModeLaborat.getRowCount()==0){
                    ...
                    param.put("cari","%"+TCari.getText().trim()+"%");                    
                    param.put("logo",Sequel.cariGambar("select logo from setting"));
                    Valid.MyReport("rptDetailLaborat.jrxml",param,"::[ Detail Pemeriksaan Laborat ]::");                    
                }   break;
            case 9:
                if(tabModeDetailLaborat.getRowCount()==0){
                    ...
                    param.put("cari","%"+TCari.getText().trim()+"%");                    
                    param.put("logo",Sequel.cariGambar("select logo from setting"));
                    Valid.MyReport("rptDetailDetailLaborat.jrxml",param,"::[ Detail Pemeriksaan Laborat ]::");                    
                }   break;
            default:
                    break;
        }
    ...
    public void tampil(){     
        ...
        try{
            ...
            try {
                ...
                ps.setString(20,"%"+NmCaraBayarRad.getText()+"%");
    ...
    public void tampil2(){     
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "where rawat_jl_pr.tgl_perawatan between ? and ? and rawat_jl_pr.no_rawat like ? and penjab.png_jawab like ? or "+
                    "rawat_jl_pr.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and penjab.png_jawab like ? or "+
                    "rawat_jl_pr.tgl_perawatan between ? and ? and pasien.nm_pasien like ? and penjab.png_jawab like ? or "+
    ...
    public void tampil3(){     
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "where rawat_jl_drpr.tgl_perawatan between ? and ? and rawat_jl_drpr.no_rawat like ? and penjab.png_jawab like ? or "+
                    "rawat_jl_drpr.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and penjab.png_jawab like ? or "+
                    "rawat_jl_drpr.tgl_perawatan between ? and ? and pasien.nm_pasien like ? and penjab.png_jawab like ? or "+
                    "rawat_jl_drpr.tgl_perawatan between ? and ? and jns_perawatan.nm_perawatan like ? and penjab.png_jawab like ? or "+
                    "rawat_jl_drpr.tgl_perawatan between ? and ? and rawat_jl_drpr.kd_dokter like ? and penjab.png_jawab like ? or "+
    ...
    public void tampil5(){     
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "where rawat_inap_dr.tgl_perawatan between ? and ? and rawat_inap_dr.no_rawat like ? and penjab.png_jawab like ? or "+
                    "rawat_inap_dr.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and penjab.png_jawab like ? or "+
                    "rawat_inap_dr.tgl_perawatan between ? and ? and pasien.nm_pasien like ? and penjab.png_jawab like ? or "+
    ...
    public void tampil6(){     
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "where rawat_inap_pr.tgl_perawatan between ? and ? and rawat_inap_pr.no_rawat like ? and penjab.png_jawab like ? or "+
                    "rawat_inap_pr.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and penjab.png_jawab like ? or "+
                    "rawat_inap_pr.tgl_perawatan between ? and ? and pasien.nm_pasien like ? and penjab.png_jawab like ? or "+
    ...
    public void tampil7(){     
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "where rawat_inap_drpr.tgl_perawatan between ? and ? and rawat_inap_drpr.no_rawat like ? and penjab.png_jawab like ? or "+
                    "rawat_inap_drpr.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and penjab.png_jawab like ? or "+
                    "rawat_inap_drpr.tgl_perawatan between ? and ? and pasien.nm_pasien like ? and penjab.png_jawab like ? or "+
                    "rawat_inap_drpr.tgl_perawatan between ? and ? and jns_perawatan_inap.nm_perawatan like ? and penjab.png_jawab like ? or "+
                    "rawat_inap_drpr.tgl_perawatan between ? and ? and rawat_inap_drpr.kd_dokter like ? and penjab.png_jawab like ? or "+
                    "rawat_inap_drpr.tgl_perawatan between ? and ? and dokter.nm_dokter like ? and penjab.png_jawab like ? or "+
                    "rawat_inap_drpr.tgl_perawatan between ? and ? and rawat_inap_drpr.nip like ? and penjab.png_jawab like ? or "+
                    "rawat_inap_drpr.tgl_perawatan between ? and ? and petugas.nama like ? and penjab.png_jawab like ? or "+
    ...
    public void tampil8(){     
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "where periksa_radiologi.tgl_periksa between ? and ? and periksa_radiologi.no_rawat like ? and penjab.png_jawab like ? or "+
                   "periksa_radiologi.tgl_periksa between ? and ? and reg_periksa.no_rkm_medis like ? and penjab.png_jawab like ? or "+
                   "periksa_radiologi.tgl_periksa between ? and ? and pasien.nm_pasien like ? and penjab.png_jawab like ? or "+
                   "periksa_radiologi.tgl_periksa between ? and ? and periksa_radiologi.kd_jenis_prw like ? and penjab.png_jawab like ? or "+
                   "periksa_radiologi.tgl_periksa between ? and ? and jns_perawatan_radiologi.nm_perawatan like ? and penjab.png_jawab like ? or "+
                   "periksa_radiologi.tgl_periksa between ? and ? and periksa_radiologi.kd_dokter like ? and penjab.png_jawab like ? or "+
                   "periksa_radiologi.tgl_periksa between ? and ? and dokter.nm_dokter like ? and penjab.png_jawab like ? or "+
                   "periksa_radiologi.tgl_periksa between ? and ? and periksa_radiologi.nip like ? and penjab.png_jawab like ? or "+
                   "periksa_radiologi.tgl_periksa between ? and ? and petugas.nama like ? and penjab.png_jawab like ? or "+
                   "periksa_radiologi.tgl_periksa between ? and ? and periksa_radiologi.dokter_perujuk like ? and penjab.png_jawab like ? or "+
                   "periksa_radiologi.tgl_periksa between ? and ? and (select nm_dokter from dokter where dokter.kd_dokter=periksa_radiologi.dokter_perujuk ) like ? and penjab.png_jawab like ? or "+
                   "periksa_radiologi.tgl_periksa between ? and ? and penjab.png_jawab like ? and penjab.png_jawab like ? or "+
                   "periksa_radiologi.tgl_periksa between ? and ? and jns_perawatan_radiologi.nm_perawatan like ? and penjab.png_jawab like ? "+
            ...
            try {
                ...
                ps.setString(39,"%"+TCari.getText().trim()+"%");
                ps.setString(40,"%"+NmCaraBayarRad.getText()+"%");
                ps.setString(41,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                ps.setString(42,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                ps.setString(43,"%"+TCari.getText().trim()+"%");
                ...
                ps.setString(52,"%"+NmCaraBayarRad.getText()+"%");
                rs=ps.executeQuery();
                i=1;
    ...
    public void tampil9(){     
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   "where periksa_lab.tgl_periksa between ? and ? and periksa_lab.no_rawat like ? and penjab.png_jawab like ? or "+
                   "periksa_lab.tgl_periksa between ? and ? and reg_periksa.no_rkm_medis like ? and penjab.png_jawab like ? or "+
                   "periksa_lab.tgl_periksa between ? and ? and pasien.nm_pasien like ? and penjab.png_jawab like ? or "+
                   "periksa_lab.tgl_periksa between ? and ? and periksa_lab.kd_jenis_prw like ? and penjab.png_jawab like ? or "+
                   "periksa_lab.tgl_periksa between ? and ? and jns_perawatan_lab.nm_perawatan like ? and penjab.png_jawab like ? or "+
                   "periksa_lab.tgl_periksa between ? and ? and periksa_lab.kd_dokter like ?and penjab.png_jawab like ? or "+
                   "periksa_lab.tgl_periksa between ? and ? and dokter.nm_dokter like ? and penjab.png_jawab like ? or "+
                   "periksa_lab.tgl_periksa between ? and ? and periksa_lab.nip like ? and penjab.png_jawab like ? or "+
    ...
    public void tampil10(){     
        ...
        try {
            ps=koneksi.prepareStatement(
                    ...
                    "where detail_periksa_lab.tgl_periksa between ? and ? and detail_periksa_lab.no_rawat like ? and penjab.png_jawab like ? or "+
                    "detail_periksa_lab.tgl_periksa between ? and ? and reg_periksa.no_rkm_medis like ? and penjab.png_jawab like ? or "+
                    "detail_periksa_lab.tgl_periksa between ? and ? and pasien.nm_pasien like ? and penjab.png_jawab like ? or "+
                    "detail_periksa_lab.tgl_periksa between ? and ? and detail_periksa_lab.kd_jenis_prw like ? and penjab.png_jawab like ? or "+
                    "detail_periksa_lab.tgl_periksa between ? and ? and jns_perawatan_lab.nm_perawatan like ? and penjab.png_jawab like ? or "+
                    "detail_periksa_lab.tgl_periksa between ? and ? and periksa_lab.kd_dokter like ? and penjab.png_jawab like ? or "+
                    "detail_periksa_lab.tgl_periksa between ? and ? and dokter.nm_dokter like ? and penjab.png_jawab like ? or "+
                    "detail_periksa_lab.tgl_periksa between ? and ? and periksa_lab.nip like ? and penjab.png_jawab like ? or "+
                    "detail_periksa_lab.tgl_periksa between ? and ? and petugas.nama like ? and penjab.png_jawab like ? or "+
                    "detail_periksa_lab.tgl_periksa between ? and ? and periksa_lab.dokter_perujuk like ? and penjab.png_jawab like ? or "+
                    "detail_periksa_lab.tgl_periksa between ? and ? and (select nm_dokter from dokter where dokter.kd_dokter=periksa_lab.dokter_perujuk ) like ? and penjab.png_jawab like ? or "+
