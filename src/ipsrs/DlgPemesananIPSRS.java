...
public class DlgPemesananIPSRS extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPemesananIPSRS(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPemesananIPSRS dialog = new DlgPemesananIPSRS(new javax.swing.JFrame(), true);
