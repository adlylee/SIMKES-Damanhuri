    ...
    public DlgCariPemesananIpsrs(java.awt.Frame parent, boolean modal) {
        ...
        suplier.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(var.getform().equals("DlgCariPemesananIPSRS")){
...
*/
    ...
    private void btnSuplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuplierActionPerformed
        var.setform("DlgCariPemesananIPSRS");
        suplier.emptTeks();
        suplier.isCek();
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptPemesananIPSRS.jrxml","report","::[ Transaksi Penerimaan Barang Non Medis ]::",
  ...
  if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),8).toString().trim().equals("")){
     ...
     try {
         ...
         while(rs.next()){
             ...
             jur.simpanJurnal(rs.getString("no_faktur"),Sequel.cariIsi("select current_date()"),"U","BATAL TRANSAKSI PENERIMAAN BARANG NON MEDIS");
         }          
