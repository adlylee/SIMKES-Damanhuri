 ...
 * @author dosen
 */
public final class SirsCekReferensiKabupaten extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public SirsCekReferensiKabupaten(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Kode Kabupaten", "Nama Kabupaten", "Kode Provinsi"}) {
            @Override
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi Kabupaten ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(70, 70, 70))); // NOI18N
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SirsCekReferensiKabupaten dialog = new SirsCekReferensiKabupaten(new javax.swing.JFrame(), true);
    ...
    public void tampil(String poli) {
        try {
            ...
            URL = link + "/api/kabkota?page=1&limit=1000";
...
//                response = root.path("response");
                    ...
                    for (JsonNode list : response) {
                        if (list.path("id").asText().toLowerCase().contains(poli.toLowerCase())
                            ...
                            tabMode.addRow(new Object[]{
                                i + ".", list.path("id").asText(), list.path("nama").asText(), list.path("provinsi_id").asText()
                            });
                        }
                        i++;
                    }
    ...
    public void setDataCari(String cari) {
        Kabupaten.setText(cari);
    }
