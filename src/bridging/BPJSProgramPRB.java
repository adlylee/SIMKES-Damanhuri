...
public final class BPJSProgramPRB extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-12-2023" }));
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptDataSRBBPJS.jasper","report","::[ Data Resep Pulang ]::",
...
//            param.put("finger","Dikeluarkan di "+var.getnamars()+", Kabupaten/Kota "+var.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+tbProgramPRB.getValueAt(tbProgramPRB.getSelectedRow(),10).toString()+"\nID "+tbProgramPRB.getValueAt(tbProgramPRB.getSelectedRow(),9).toString()+"\n"+Valid.SetTgl3(tbProgramPRB.getValueAt(tbProgramPRB.getSelectedRow(),8).toString()));  
            ...
            Valid.MyReport("rptBridgingSuratSRB.jasper","report","::[ Data Surat SRB BPJS ]::",
    ...
    */
    ...
    public void isCek(){
//        btnDokterDPJP.setEnabled(var.getbpjs_program_prb());
//        BtnHapus.setEnabled(var.getbpjs_program_prb());
//        BtnPrint.setEnabled(var.getbpjs_program_prb());
    }
