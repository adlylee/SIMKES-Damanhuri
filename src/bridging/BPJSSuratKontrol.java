...
public class BPJSSuratKontrol extends javax.swing.JDialog {
    ...
    public BPJSSuratKontrol(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "No.Surat", "Tgl.Kontrol", "Kode Dokter", "Nama Dokter/Spesialis", "Kode Poli", "Nama Poli/Unit"
        }) {
            @Override
    ...
    private void initComponents() {
        ...
        MnSurat3 = new javax.swing.JMenuItem();
        ...
        MnSurat3.setBackground(new java.awt.Color(255, 255, 254));
        MnSurat3.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnSurat3.setForeground(new java.awt.Color(50, 50, 50));
        MnSurat3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnSurat3.setText("Cari Surat Kontrol /SPRI");
        MnSurat3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnSurat3.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnSurat3.setName("MnSurat3"); // NOI18N
        MnSurat3.setPreferredSize(new java.awt.Dimension(160, 26));
        MnSurat3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnSurat3ActionPerformed(evt);
            }
        });
        jPopupMenu2.add(MnSurat3);
        ...
        DTPTanggalSurat1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2022" }));
        ...
        DTPTanggalSurat2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2022" }));
        ...
        DTPTanggalKontrol1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2022" }));
        ...
        DTPTanggalKontrol2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2022" }));
        ...
        jLabel9.setBounds(360, 100, 90, 23);

        NmDokter.setEditable(false);
        NmDokter.setHighlighter(null);
        NmDokter.setName("NmDokter"); // NOI18N
        FormInput.add(NmDokter);
        NmDokter.setBounds(545, 100, 160, 23);
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2022" }));
        ...
        KdDokter.setBounds(455, 100, 87, 23);
        ...
        BtnDokter.setBounds(705, 100, 28, 23);
        ...
        KdPoli.setBounds(95, 100, 70, 23);

        NmPoli.setEditable(false);
        NmPoli.setHighlighter(null);
        NmPoli.setName("NmPoli"); // NOI18N
        FormInput.add(NmPoli);
        NmPoli.setBounds(168, 100, 165, 23);
        ...
        BtnPoli.setBounds(335, 100, 28, 23);
        ...
        TanggalKontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2022" }));
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
    ...
    private void MnSuratActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSuratActionPerformed
        if (tbObat.getSelectedRow() != -1) {
            ...
            Valid.MyReport("rptBridgingSuratKontrol2.jrxml", "report", "::[ Data Surat Kontrol VClaim ]::",
                    "select bridging_sep.no_rawat,bridging_sep.no_sep,bridging_sep.no_kartu,bridging_sep.nomr,bridging_sep.nama_pasien,bridging_sep.tanggal_lahir,"
                    + "bridging_sep.jkel,bridging_sep.diagawal,bridging_sep.nmdiagnosaawal,bridging_surat_kontrol_bpjs.tgl_surat,bridging_surat_kontrol_bpjs.no_surat,"
                    + "bridging_surat_kontrol_bpjs.tgl_rencana,bridging_surat_kontrol_bpjs.kd_dokter_bpjs,bridging_surat_kontrol_bpjs.nm_dokter_bpjs,"
                    + "bridging_surat_kontrol_bpjs.kd_poli_bpjs,bridging_surat_kontrol_bpjs.nm_poli_bpjs from bridging_sep inner join bridging_surat_kontrol_bpjs "
    ...
    }//GEN-LAST:event_MnSurat3ActionPerformed
    ...
    private javax.swing.JMenuItem MnSurat3;
    ...
    public void setNoRm(String norawat, String nosep, String nokartu, String norm, String namapasien, String tanggallahir, String jk, String diagnosa, String kdpoli, String date) {
        ...
        Valid.SetTgl(TanggalSurat, date);
        TCari.setText(nosep);
        ChkInput.setSelected(true);
        NoSurat.setVisible(false);
    ...
    public void isCek() {
        BtnSimpan.setEnabled(var.getbpjs_cek_skdp());
        BtnHapus.setEnabled(var.getbpjs_cek_skdp());
        BtnPrint.setEnabled(var.getbpjs_cek_skdp());
        BtnEdit.setEnabled(var.getbpjs_cek_skdp());
    }

    public String simpanSurat(String nosep, String tanggalkontrol, String tanggalsurat, String kddokter, String nmdokter, String kdpoli, String nmpoli, String user) {
        String respon = "";
        try {
