...
//            Sequel.queryu("delete from temporary where temp37='"+var.getalamatip()+"'");
//            int row=tabMode.getRowCount();
//            for(int r=0;r<row;r++){  
//                Sequel.menyimpan("temporary","'"+r+"','"+
//                                tabMode.getValueAt(r,0).toString()+"','"+
//                                tabMode.getValueAt(r,1).toString()+"','"+
//                                tabMode.getValueAt(r,2).toString()+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+var.getalamatip()+"'","Rekap Harian Pengadaan Ipsrs"); 
//            }
//            
...
//            Valid.MyReportqry("rptCariBPJSReferensiDiagnosaPRB.jasper","report","[ Pencarian Referensi Diagnosa PRB ]","select * from temporary where temporary.temp37='"+var   .getalamatip()+"' order by temporary.no",param);
