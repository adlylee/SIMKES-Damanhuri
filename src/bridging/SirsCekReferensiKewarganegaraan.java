 ...
 * @author dosen
 */
public final class SirsCekReferensiKewarganegaraan extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public SirsCekReferensiKewarganegaraan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Kode Kewarganegaraan", "Nama Kewarganegaraan"}) {
            @Override
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi Kewarganegaraan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(70, 70, 70))); // NOI18N
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SirsCekReferensiKewarganegaraan dialog = new SirsCekReferensiKewarganegaraan(new javax.swing.JFrame(), true);
    ...
    public void tampil(String poli) {
        try {
            ...
            URL = link + "/api/kewarganegaraan?page=1&limit=1000";
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {
                        if (list.path("id").asText().toLowerCase().contains(poli.toLowerCase())
                                || list.path("nicename").asText().toLowerCase().contains(poli.toLowerCase())) {
                            tabMode.addRow(new Object[]{
                                i + ".", list.path("id").asText(), list.path("nicename").asText()
                            });
                        }
                        i++;
                    }
