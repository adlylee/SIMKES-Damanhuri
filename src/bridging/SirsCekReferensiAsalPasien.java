 ...
 * @author dosen
 */
public final class SirsCekReferensiAsalPasien extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public SirsCekReferensiAsalPasien(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Kode Asal Pasien", "Nama Asal Pasien"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SirsCekReferensiAsalPasien dialog = new SirsCekReferensiAsalPasien(new javax.swing.JFrame(), true);
    ...
    public void tampil(String poli) {
        try {
            ...
            URL = link + "/api/asalpasien?page=1&limit=1000";
