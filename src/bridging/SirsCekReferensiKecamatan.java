 ...
 * @author dosen
 */
public final class SirsCekReferensiKecamatan extends javax.swing.JDialog {
    ...
    private String URL = "", link = "", token, page;
     ...
     * @param modal
     */
    public SirsCekReferensiKecamatan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Kode Kecamatan", "Nama Kecamatan", "Kode Kabupaten"}) {
            @Override
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi Kecamatan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(70, 70, 70))); // NOI18N
        ...
        jLabel18.setPreferredSize(new java.awt.Dimension(20, 23));
        panelGlass6.add(jLabel18);

        jLabel37.setText("Halaman :");
        jLabel37.setName("jLabel37"); // NOI18N
        panelGlass6.add(jLabel37);

        Status.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "1", "2", "3", "4", "5", "6", "7", "8" }));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SirsCekReferensiKecamatan dialog = new SirsCekReferensiKecamatan(new javax.swing.JFrame(), true);
    ...
    public void tampil(String poli) {
        try {
            ...
            URL = link + "/api/kecamatan?page=" + page + "&limit=1000";
            root = mapper.readTree(api.getRest().exchange(URL, HttpMethod.GET, requestEntity, String.class).getBody());
            nameNode = root.path("status");
//            System.out.println(root);
            if (nameNode.asText().equals("true")) {
...
//                response = root.path("response");
                    ...
                    for (JsonNode list : response) {
                        if (list.path("id").asText().toLowerCase().contains(poli.toLowerCase())
                            ...
                            tabMode.addRow(new Object[]{
                                i + ".", list.path("id").asText(), list.path("nama").asText(), list.path("kab_kota_id").asText()
                            });
                        }
                        i++;
                    }
    ...
    public void setToken(String tokenku){
        token = tokenku;
    }
}
