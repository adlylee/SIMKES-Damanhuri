 ...
 * @author dosen
 */
public final class SirsCekReferensiJenisPasien extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public SirsCekReferensiJenisPasien(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Kode Jenis Pasien", "Nama Jenis Pasien"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SirsCekReferensiJenisPasien dialog = new SirsCekReferensiJenisPasien(new javax.swing.JFrame(), true);
    ...
    public void tampil(String poli) {
        try {
            ...
            URL = link + "/api/jenispasien?page=1&limit=1000";
