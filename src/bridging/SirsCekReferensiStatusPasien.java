 ...
 * @author dosen
 */
public final class SirsCekReferensiStatusPasien extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public SirsCekReferensiStatusPasien(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Kode Status Pasien", "Nama Status Pasien"}) {
            @Override
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi Asal Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(70, 70, 70))); // NOI18N
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SirsCekReferensiStatusPasien dialog = new SirsCekReferensiStatusPasien(new javax.swing.JFrame(), true);
    ...
    public void tampil(String poli) {
        try {
            ...
            URL = link + "/api/statuspasien?page=1&limit=1000";
