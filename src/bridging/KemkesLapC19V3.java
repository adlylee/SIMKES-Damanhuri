 ...
 * @author perpustakaan
 */
public final class KemkesLapC19V3 extends javax.swing.JDialog {
    ...
    private String prb = "", no_peserta = "", link = "", requestJson, URL = "", jkel = "", duplikat = "", user = "", penjamin = "", jasaraharja = "", BPJS = "", Taspen = "", Asabri = "", kddokter = "", tglkkl = "0000-00-00", antrian = "", klsRawat = "", dpjlayan = "", sep2tambah = "", penjaminan = "";
     ...
     * @param modal
     */
    public KemkesLapC19V3(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-12-2021 09:27:07" }));
        ...
        TanggalRujukKeluar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-12-2021" }));
        ...
        TanggalKunjungan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-12-2021" }));
        ...
        TanggalSEP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-12-2021" }));
        ...
        TanggalRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-12-2021" }));
        ...
        TanggalKKL.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-12-2021" }));
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-12-2021" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-12-2021" }));
...
//        } else if (NoSKDP.getText().length() > 6) {
//            JOptionPane.showMessageDialog(null, "No SKDP Tidak Boleh Lebih Dari 6");
        } else {
//            while (true) {
//                if (Sequel.cariInteger("select count(no_antrian) from skdp_bpjs where tahun='" + TanggalSEP.getSelectedItem().toString().substring(6, 10) + "' and no_antrian = '" + antrian + "'") > 0) {
        ...
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            try {
                ...
                if(koneksiDB.UrlBpjs().contains("apijkn")){
                    ...
                    URL = koneksiDB.UrlBpjs() + "/Sep/updtglplg";
                    requestJson = "{"
                            + "\"request\":"
                            + "{"
                            + "\"t_sep\":"
...
//                response = root.path("response");
    ...
    private void cmbKunjunganItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbKunjunganItemStateChanged
        // TODO add your handling code here:
        if (cmbKunjungan.getSelectedIndex() == 0 || cmbKunjungan.getSelectedIndex() == 2) {
            cmbProcedure.setEnabled(false);
            cmbPenunjang.setEnabled(false);
        } else {
...
//                btnTambahProsedurActionPerformed(null);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KemkesLapC19V3 dialog = new KemkesLapC19V3(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                if (Sequel.menyimpantf("bridging_sep", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "SEP", 44, new String[]{
                    ...
                    tglkkl, Keterangan.getText(), Suplesi.getSelectedItem().toString(),
                    NoSEPSuplesi.getText(), KdPropinsi.getText(), NmPropinsi.getText(), KdKabupaten.getText(), NmKabupaten.getText(),
                    KdKecamatan.getText(), NmKecamatan.getText(), antrian, KdDPJP.getText(), NmDPJP.getText()
                }) == true) {
...
//                            headers.add("X-Timestamp", String.valueOf(api.GetUTCdatetimeAsString()));
//                            headers.add("X-Signature", api.getHmac());
//                            if (koneksiDB.UrlBpjs().contains("apijkn-dev.bpjs-kesehatan.go.id/vclaim-rest-dev")) {
//                                URL = koneksiDB.UrlBpjs() + "/SEP/2.0/updtglplg";
//                                headers.add("user_key", koneksiDB.UserKeyBpjs());
//                                requestJson = "{"
//                                        + "\"request\":"
