 ...
 * @author dosen
 */
public final class SirsCekReferensiStatusRawat extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public SirsCekReferensiStatusRawat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Kode Status Rawat", "Nama Status Rawat"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SirsCekReferensiStatusRawat dialog = new SirsCekReferensiStatusRawat(new javax.swing.JFrame(), true);
    ...
    public void tampil(String poli) {
        try {
            ...
            URL = link + "/api/statusrawat?page=1&limit=1000";
