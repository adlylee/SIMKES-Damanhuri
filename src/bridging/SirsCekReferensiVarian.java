 ...
 * @author dosen
 */
public final class SirsCekReferensiVarian extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public SirsCekReferensiVarian(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Kode Varian", "Nama Varian"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SirsCekReferensiVarian dialog = new SirsCekReferensiVarian(new javax.swing.JFrame(), true);
...
//            token = api.getToken();
            ...
            URL = link + "/api/variancovid?page=1&limit=1000";
