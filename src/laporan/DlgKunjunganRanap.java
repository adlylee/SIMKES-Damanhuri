...
public final class DlgKunjunganRanap extends javax.swing.JDialog {
    private final DefaultTableModel tabMode,tabMode2,tabmodeGeriatri, tabModeGzBuruk;
    ...
    public DlgKunjunganRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabmodeGeriatri=new DefaultTableModel(null,new String[]{"No.","Lama","Baru","Nama Pasien","L","P","Kode","Diagnosa","Ruang","Stts.Pulang","Tgl.Pulang","DPJP"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        tbTambahan.setModel(tabmodeGeriatri);
    ...
    private void initComponents() {
        ...
        BtnGiziBuruk = new widget.Button();
        ...
        scrollPane4.setViewportView(tbTambahan);
        ...
        label24.setPreferredSize(new java.awt.Dimension(25, 23));
        ...
        internalFrame8.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Laporan Data Balita Gizi Buruk ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("sansserif", 1, 12), new java.awt.Color(70, 70, 70))); // NOI18N
        ...
        tbGiziBuruk.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        scrollPane5.setViewportView(tbGiziBuruk);

        internalFrame8.add(scrollPane5, java.awt.BorderLayout.CENTER);
        ...
        panelisi5.add(label13);

        Tgl5.setDisplayFormat("dd-MM-yyyy");
        Tgl5.setName("Tgl5"); // NOI18N
        Tgl5.setPreferredSize(new java.awt.Dimension(90, 23));
        panelisi5.add(Tgl5);

        label25.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        label25.setText("s.d.");
        label25.setName("label25"); // NOI18N
        label25.setPreferredSize(new java.awt.Dimension(25, 23));
        panelisi5.add(label25);

        Tgl6.setDisplayFormat("dd-MM-yyyy");
        Tgl6.setName("Tgl6"); // NOI18N
        Tgl6.setPreferredSize(new java.awt.Dimension(90, 23));
        panelisi5.add(Tgl6);
        ...
        TCari1.setPreferredSize(new java.awt.Dimension(155, 23));
        ...
        panelisi5.add(BtnKeluar5);

        internalFrame8.add(panelisi5, java.awt.BorderLayout.PAGE_END);

        WindowGiziBuruk.getContentPane().add(internalFrame8, java.awt.BorderLayout.CENTER);

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setUndecorated(true);
        setResizable(false);

        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Kunjungan Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("sansserif", 1, 12), new java.awt.Color(70, 70, 70))); // NOI18N
        ...
        BtnGeriatri.setBounds(850, 10, 130, 30);

        BtnGiziBuruk.setText("Data Gizi Buruk");
        BtnGiziBuruk.setToolTipText("");
        BtnGiziBuruk.setName("BtnGiziBuruk"); // NOI18N
        BtnGiziBuruk.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnGiziBuruk.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnGiziBurukActionPerformed(evt);
            }
        });
        BtnGiziBuruk.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnGiziBurukKeyPressed(evt);
            }
        });
        FormInput.add(BtnGiziBuruk);
        BtnGiziBuruk.setBounds(850, 40, 130, 30);
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void BtnPrint2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint2ActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if(tabmodeGeriatri.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis. Tidak ada data yang bisa anda print...!!!!");
            //TCari.requestFocus();
        }else if(tabmodeGeriatri.getRowCount()!=0){
            ...
            param.put("kontakrs",var.getkontakrs());
            param.put("emailrs",var.getemailrs());
            param.put("periode",Tgl3.getSelectedItem()+" s.d. "+Tgl4.getSelectedItem());
            param.put("lama",lama);
            param.put("baru",baru);
            param.put("total",(lama+baru));
            param.put("laki",laki);
            param.put("perempuan",per);
            param.put("tanggal",Tgl4.getDate());
            Sequel.queryu("truncate table temporary");
            for(int r=0;r<tabmodeGeriatri.getRowCount();r++){
                if(!tbTambahan.getValueAt(r,0).toString().contains(">>")){
                    Sequel.menyimpan("temporary","'0','"+
                        tabmodeGeriatri.getValueAt(r,0).toString()+"','"+
                        tabmodeGeriatri.getValueAt(r,1).toString()+"','"+
                        tabmodeGeriatri.getValueAt(r,2).toString()+"','"+
                        tabmodeGeriatri.getValueAt(r,3).toString()+"','"+
                        tabmodeGeriatri.getValueAt(r,4).toString()+"','"+
                        tabmodeGeriatri.getValueAt(r,5).toString()+"','"+
                        tabmodeGeriatri.getValueAt(r,6).toString()+"','"+
                        tabmodeGeriatri.getValueAt(r,7).toString()+"','"+
                        tabmodeGeriatri.getValueAt(r,8).toString()+"','"+
                        tabmodeGeriatri.getValueAt(r,9).toString()+"','"+
                        tabmodeGeriatri.getValueAt(r,10).toString()+"','"+
                        tabmodeGeriatri.getValueAt(r,11).toString()+"','','','','','','','','','','','','','','','','','','','','','','','','',''","Data");
                }
            }

            Valid.MyReport("rptGeriatriRanap.jrxml","report","::[ Laporan Pelayanan Rawat Inap Geriatri ]::",
                "select * from temporary order by no asc",param);
        }
        this.setCursor(Cursor.getDefaultCursor());
    ...
    private void BtnGiziBurukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGiziBurukActionPerformed
        WindowGiziBuruk.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
        WindowGiziBuruk.setLocationRelativeTo(internalFrame1);
        WindowGiziBuruk.setVisible(true);
    }//GEN-LAST:event_BtnGiziBurukActionPerformed

    private void BtnGiziBurukKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnGiziBurukKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnGiziBurukKeyPressed
    ...
    */
    ...
    private widget.Button BtnGiziBuruk;
    ...
    private javax.swing.JDialog WindowGiziBuruk;
    private javax.swing.JDialog WindowInput;
    private widget.ComboBox cmbCari;
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new Object[]{
                        i,setlama,setbaru,rs.getString("nm_pasien"),umurlk,umurpr,rs.getString("almt_pj"),kddiagnosa,diagnosa,rs.getString("kd_kamar")+" "+rs.getString("nm_bangsal"),rs.getString("stts_pulang"),rs.getString("tgl_masuk"),dpjp
                    });                
                    i++;
                }
                if(i>=2){
    ...
    public void tampilCari(){        
        try{   
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR)); 
            Valid.tabelKosong(tabMode);   
            if (cmbCari.getSelectedItem().toString() == "Diagnosa") {
                key = "reg_periksa.status_lanjut='Ranap' and reg_periksa.stts<>'Batal' and reg_periksa.tgl_registrasi between ? and ? and bangsal.nm_bangsal like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and diagnosa_pasien.kd_penyakit like ? ";
            } else if (cmbCari.getSelectedItem().toString() == "No Rekam Medis"){
                key = "reg_periksa.status_lanjut='Ranap' and reg_periksa.stts<>'Batal' and reg_periksa.tgl_registrasi between ? and ? and bangsal.nm_bangsal like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and reg_periksa.no_rkm_medis like ? ";
            } else {
                key = "reg_periksa.status_lanjut='Ranap' and reg_periksa.stts<>'Batal' and reg_periksa.tgl_registrasi between ? and ? and bangsal.nm_bangsal like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and pasien.nm_pasien like ? ";
            }
            ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.alamat,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) as umur,pasien.tgl_daftar,"+
                    "kamar_inap.kd_kamar,bangsal.nm_bangsal,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab)as almt_pj,kamar_inap.stts_pulang,kamar_inap.tgl_masuk,dokter.nm_dokter "+
                    "from reg_periksa inner join pasien inner join kamar_inap inner join kamar inner join bangsal inner join dokter inner join penjab " +
                    "inner join kabupaten inner join kecamatan inner join kelurahan inner join diagnosa_pasien  on reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.no_rawat=kamar_inap.no_rawat "+
                    "and reg_periksa.kd_pj=penjab.kd_pj and pasien.kd_kab=kabupaten.kd_kab and kamar_inap.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal "+
                    "and reg_periksa.kd_dokter=dokter.kd_dokter and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel and reg_periksa.no_rawat = diagnosa_pasien.no_rawat where "+                  
                    key+
                    "group by reg_periksa.no_rawat order by reg_periksa.tgl_registrasi");
            try {
                ps.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
    ...
    public void tampilCari2(){        
        ...
        try{   
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR)); 
            Valid.tabelKosong(tabmodeGeriatri);   
            ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli,pasien.jk," +
                    "concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) as umur,pasien.tgl_daftar,kamar_inap.kd_kamar,bangsal.nm_bangsal,kamar_inap.stts_pulang,kamar_inap.tgl_masuk,dokter.nm_dokter " +
                    "from pasien inner join reg_periksa inner join kamar_inap inner join kamar inner join bangsal inner join poliklinik inner join dokter inner join penjab " +
                    "on pasien.no_rkm_medis=reg_periksa.no_rkm_medis and kamar_inap.no_rawat=reg_periksa.no_rawat and reg_periksa.kd_poli=poliklinik.kd_poli and reg_periksa.kd_dokter=dokter.kd_dokter and reg_periksa.kd_pj=penjab.kd_pj and kamar_inap.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal where "+                  
                    "reg_periksa.status_lanjut='Ranap' and reg_periksa.stts<>'Batal' and reg_periksa.umurdaftar>60 and reg_periksa.tgl_registrasi between ? and ? and bangsal.nm_bangsal like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and (pasien.alamat like ? or "+
                    "pasien.nm_pasien like ? or "+
                    "dokter.nm_dokter like ? or "+
                    "reg_periksa.no_rkm_medis like ? or "+
                    "kamar_inap.kd_kamar like ?) "+
                    "group by pasien.no_rkm_medis order by reg_periksa.tgl_registrasi asc");
            try {
                ps.setString(1,Valid.SetTgl(Tgl3.getSelectedItem()+""));
                ps.setString(2,Valid.SetTgl(Tgl4.getSelectedItem()+""));
                ps.setString(3,"%"+nmkamar.getText().trim()+"%");
                ps.setString(4,"%"+nmdokter.getText().trim()+"%");
                ps.setString(5,"%"+nmpenjab.getText().trim()+"%");
                ...
                while(rs.next()){
                    ...
                    tabmodeGeriatri.addRow(new Object[]{
                        i,setlama,setbaru,rs.getString("nm_pasien"),umurlk,umurpr,kddiagnosa,diagnosa,rs.getString("kd_kamar")+" "+rs.getString("nm_bangsal"),rs.getString("stts_pulang"),rs.getString("tgl_masuk"),dpjp
                    });                
                    i++;
                }
                if(i>=2){
    ...
    public void OnChange() {
        TableRowSorter< DefaultTableModel> sorter = new TableRowSorter< DefaultTableModel>(tabMode);
        tbBangsal.setRowSorter(sorter);
        String txt = TCari.getText().toLowerCase();
        try {
    ...
    private void tampilGiziBuruk() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + " ");
            try {
                ps.setString(1, Valid.SetTgl(Tgl5.getSelectedItem() + ""));
                ps.setString(2, Valid.SetTgl(Tgl6.getSelectedItem() + ""));
        ...
        LCount.setText("" + tabModeGzBuruk.getRowCount());
    }
}
