...
public class DlgFrekuensiPenyakitRalanDanRanap extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgFrekuensiPenyakitRalanDanRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgFrekuensiPenyakitRalanDanRanap dialog = new DlgFrekuensiPenyakitRalanDanRanap(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{ 
            String query = "select penyakit.kd_penyakit,SUBSTRING(penyakit.nm_penyakit,1,80) as penyakit , COUNT(penyakit.kd_penyakit) as jml from penyakit inner join diagnosa_pasien inner join reg_periksa "+
                ...
                "where diagnosa_pasien.prioritas='1' and reg_periksa.tgl_registrasi between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and (penyakit.kd_penyakit like ? or penyakit.nm_penyakit like ?) "+
