 ...
 * @author perpustakaan
 */
public final class DlgRekapKegiatanRad extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRekapKegiatanRad(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Rekap Kegiatan Radiologi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(70, 70, 70))); // NOI18N
        ...
        jLabel37.setText("Dokter P.J :");
        jLabel37.setName("jLabel37"); // NOI18N
        jLabel37.setPreferredSize(new java.awt.Dimension(65, 23));
        panelGlass5.add(jLabel37);

        cmbDokter.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "dr. Harkani, M. Kes, Sp. RAD", "dr. Muhammad Novyan, Sp. Rad" }));
        cmbDokter.setName("cmbDokter"); // NOI18N
        cmbDokter.setPreferredSize(new java.awt.Dimension(220, 23));
        cmbDokter.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbDokterActionPerformed(evt);
            }
        });
        panelGlass5.add(cmbDokter);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptRekapKegiatanRad.jrxml","report","::[ Rekap Kegiatan Radiologi ]::",
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRekapKegiatanRad dialog = new DlgRekapKegiatanRad(new javax.swing.JFrame(), true);
    ...
    public void tampil(){
        ...
        if (cmbDokter.getSelectedItem().equals("dr. Harkani, M. Kes, Sp. RAD")) {
            dokter = " and periksa_radiologi.kd_dokter='DR00019' ";                     
        }
        if (cmbDokter.getSelectedItem().equals("dr. Muhammad Novyan, Sp. Rad")) {
            dokter = " and periksa_radiologi.kd_dokter='D0000132' ";                     
        }        
        try {
            pstindakan = koneksi.prepareStatement("select jns_perawatan_radiologi.nm_perawatan,count(jns_perawatan_radiologi.nm_perawatan) from periksa_radiologi "
                    ...
                    + "where periksa_radiologi.tgl_periksa between ? and ? " + dokter + " and jns_perawatan_radiologi.nm_perawatan like ? group by jns_perawatan_radiologi.nm_perawatan ");
            try {
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
