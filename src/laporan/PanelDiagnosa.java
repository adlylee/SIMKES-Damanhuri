    ...
    public void tampil() {
        ...
        try{            
            psdiagnosapasien=koneksi.prepareStatement("select reg_periksa.tgl_registrasi,diagnosa_pasien.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                    ...
                    "reg_periksa.tgl_registrasi between ? and ? and reg_periksa.no_rkm_medis like ? and pasien.nm_pasien like ? and diagnosa_pasien.status = ? or "+
                    "reg_periksa.tgl_registrasi between ? and ? and reg_periksa.no_rkm_medis like ? and diagnosa_pasien.kd_penyakit like ? and diagnosa_pasien.status = ? or "+
                    "reg_periksa.tgl_registrasi between ? and ? and reg_periksa.no_rkm_medis like ? and penyakit.nm_penyakit like ? and diagnosa_pasien.status = ? or "+
            ...
            try {
                ...
                psdiagnosapasien.setString(6,tanggal1);
                psdiagnosapasien.setString(7,tanggal2);
                psdiagnosapasien.setString(8,"%"+norm+"%");          
                psdiagnosapasien.setString(9,"%"+keyword+"%");
                psdiagnosapasien.setString(10,status);
                psdiagnosapasien.setString(11,tanggal1);
                psdiagnosapasien.setString(12,tanggal2);
                psdiagnosapasien.setString(13,"%"+norm+"%");  
                psdiagnosapasien.setString(14,"%"+keyword+"%");
                psdiagnosapasien.setString(15,status);
                psdiagnosapasien.setString(16,tanggal1);
                psdiagnosapasien.setString(17,tanggal2);
                psdiagnosapasien.setString(18,"%"+norm+"%"); 
                psdiagnosapasien.setString(19,"%"+keyword+"%");
                psdiagnosapasien.setString(20,status);
                ...
                psdiagnosapasien.setString(25,status);
                psdiagnosapasien.setString(26,tanggal1);
                psdiagnosapasien.setString(27,tanggal2);
                psdiagnosapasien.setString(28,"%"+norm+"%");          
                psdiagnosapasien.setString(29,"%"+keyword+"%");
                psdiagnosapasien.setString(30,status);
                psdiagnosapasien.setString(31,tanggal1);
                psdiagnosapasien.setString(32,tanggal2);
                psdiagnosapasien.setString(33,"%"+norm+"%");          
                psdiagnosapasien.setString(34,"%"+keyword+"%"); 
                psdiagnosapasien.setString(35,status);
                psdiagnosapasien.setString(36,tanggal1);
                psdiagnosapasien.setString(37,tanggal2);
                psdiagnosapasien.setString(38,"%"+norm+"%");
                psdiagnosapasien.setString(39,"%"+keyword+"%");
                psdiagnosapasien.setString(40,status);
                psdiagnosapasien.setString(41,tanggal1);
                psdiagnosapasien.setString(42,tanggal2);
                psdiagnosapasien.setString(43,"%"+norm+"%");
                psdiagnosapasien.setString(44,"%"+keyword+"%");
                psdiagnosapasien.setString(45,status);
