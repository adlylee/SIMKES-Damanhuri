        ...
        try{   
            ...
            for (int j = 0; j < pnykt.length; j++) {
                hr0s7=0;hr8s28=0;kr1th=0;th1s4=0;th5s9=0;th10s14=0;th15s19=0;th20s44=0;th45s54=0;th55s59=0;th60s69=0;th70plus=0;laki=0;per=0;jml=0;ttl=0;meninggal=0;
                    ...
                    "diagnosa_pasien.status='Ranap' and diagnosa_pasien.prioritas='1' and reg_periksa.tgl_registrasi between ? and ?  and diagnosa_pasien.kd_penyakit in (SELECT diagnosa_pasien.kd_penyakit " +
                    ...
                    rs=ps.executeQuery();
                    while (rs.next()) {
                        meninggal=meninggal+Sequel.cariInteger("select ifnull(count(pasien_mati.no_rkm_medis),0) from pasien_mati where pasien_mati.no_rkm_medis=?",rs.getString("no_rkm_medis"));
                        ttl=ttl+1;
                        jmltotal=jmltotal+1;
                    ...
                    tabMode.addRow(new Object[]{
                       i, pnykt[j][1],pny,hr0s7,hr8s28,kr1th,th1s4,th5s9,th10s14,th15s19,th20s44,th45s54,th55s59,th60s69,th70plus,laki,per,jml,ttl,meninggal
                    });
                    i++;
            }            
            this.setCursor(Cursor.getDefaultCursor());
        ...
        try{   
            ...
            for (int j = 0; j < pnykt.length; j++) {
                hr0s7=0;hr8s28=0;kr1th=0;th1s4=0;th5s9=0;th10s14=0;th15s19=0;th20s44=0;th45s54=0;th55s59=0;th60s69=0;th70plus=0;laki=0;per=0;jml=0;ttl=0;meninggal=0;
                    ...
                    "diagnosa_pasien.status='Ranap' and diagnosa_pasien.prioritas='1' and kamar_inap.tgl_keluar between ? and ? and diagnosa_pasien.kd_penyakit in (SELECT diagnosa_pasien.kd_penyakit " +
                    "FROM reg_periksa inner join diagnosa_pasien " +
                    "on reg_periksa.no_rawat=diagnosa_pasien.no_rawat " +
                    "WHERE diagnosa_pasien.kd_penyakit in ("+pnykt[j][1]+")) " +
                    "group by diagnosa_pasien.no_rawat");
