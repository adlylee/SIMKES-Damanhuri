...
public class DlgFrekuensiPenyakitPerRujukMasuk extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgFrekuensiPenyakitPerRujukMasuk(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        Object[] row={"Kode","Nama Penyakit","Nama Perujuk","Jumlah Kunjungan"};
...
//        tbDokter.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
    ...
    private void initComponents() {
        ...
        jComboBox1.setPreferredSize(new java.awt.Dimension(80, 27));
        jComboBox1.setSize(new java.awt.Dimension(115, 27));
        panelisi1.add(jComboBox1);

        label9.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        label9.setText("Record : 0");
        label9.setName("label9"); // NOI18N
        label9.setPreferredSize(new java.awt.Dimension(115, 30));
        ...
        AsalRujukan.setPreferredSize(new java.awt.Dimension(215, 23));
        FormInput.add(AsalRujukan);
        AsalRujukan.setBounds(539, 10, 260, 23);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgFrekuensiPenyakitPerRujukMasuk dialog = new DlgFrekuensiPenyakitPerRujukMasuk(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{ 
            String query = "select penyakit.kd_penyakit,SUBSTRING(penyakit.nm_penyakit,1,80) as penyakit , COUNT(penyakit.kd_penyakit) as jml, rujuk_masuk.perujuk from penyakit inner join diagnosa_pasien inner join reg_periksa "+
                "inner join dokter inner join pasien inner join poliklinik inner join penjab inner join rujuk_masuk "+
                ...
                "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_pj=penjab.kd_pj and reg_periksa.kd_poli=poliklinik.kd_poli AND reg_periksa.no_rawat=rujuk_masuk.no_rawat "+
                "where reg_periksa.tgl_registrasi between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and rujuk_masuk.perujuk like ? and (penyakit.kd_penyakit like ? or penyakit.nm_penyakit like ?) "+
            ...
            try {
                ...
                ps.setString(6,"%"+AsalRujukan.getText().trim()+"%");
                ...
                while(rs.next()){
                    ...
                    ps5=koneksi.prepareStatement("select diagnosa_pasien.no_rawat as jumlah from diagnosa_pasien inner join reg_periksa "+
                       "inner join pasien inner join rujuk_masuk on reg_periksa.no_rawat=diagnosa_pasien.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis AND reg_periksa.no_rawat=rujuk_masuk.no_rawat "+
                       "where reg_periksa.tgl_registrasi between ? and ? "+
                       "and diagnosa_pasien.kd_penyakit=? and rujuk_masuk.perujuk like ? group by diagnosa_pasien.no_rawat");
                    try{
                        ...
                        ps5.setString(4,"%"+AsalRujukan.getText().trim()+"%");
...
//                    System.out.println(rs.getString("jml"));
                    tabMode.addRow(new Object[]{rs.getString("kd_penyakit"),rs.getString("penyakit"),rs.getString("perujuk"),c});
