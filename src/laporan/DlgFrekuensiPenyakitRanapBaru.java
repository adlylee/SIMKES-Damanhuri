...
public class DlgFrekuensiPenyakitRanapBaru extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgFrekuensiPenyakitRanapBaru(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        label9.setText("Record : 0 dari 0");
        ...
        internalFrame1.getAccessibleContext().setAccessibleName(":::[ Rekap Frekuensi Penyakit Di Rawat Inap ]:::");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgFrekuensiPenyakitRanapBaru dialog = new DlgFrekuensiPenyakitRanapBaru(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
       ...
       try{   
           String query = "select penyakit.kd_penyakit,SUBSTRING(penyakit.nm_penyakit,1,80) as penyakit , COUNT(penyakit.kd_penyakit) as jml from penyakit inner join diagnosa_pasien inner join reg_periksa "+
                ...
                "where diagnosa_pasien.status='Ralan' and diagnosa_pasien.prioritas='1' and reg_periksa.tgl_registrasi between ? and ? and bangsal.nm_bangsal like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and (penyakit.kd_penyakit like ? or penyakit.nm_penyakit like ?) "+
    ...
    private void tampil2() {
       ...
       try{   
           String query = "select penyakit.kd_penyakit,SUBSTRING(penyakit.nm_penyakit,1,80) as penyakit, COUNT(penyakit.kd_penyakit) as jml from penyakit inner join diagnosa_pasien inner join reg_periksa "+
                ...
                "and pasien.kd_kab=kabupaten.kd_kab and kamar_inap.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal and reg_periksa.kd_dokter=dokter.kd_dokter "+
                "and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel "+
                "where kamar_inap.stts_pulang<>'Pindah Kamar' and diagnosa_pasien.status='Ralan' and diagnosa_pasien.prioritas='1' and kamar_inap.tgl_keluar between ? and ? and bangsal.nm_bangsal like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and (penyakit.kd_penyakit like ? or penyakit.nm_penyakit like ?) "+
                "group by penyakit.kd_penyakit order by jml";
            if (jComboBox1.getSelectedItem() == "10") 
            {
                query += " DESC limit 10 ";
            ...
            try {
                ...
                while(rs.next()){
                   ...
                   ps2=koneksi.prepareStatement("select diagnosa_pasien.no_rawat from pasien inner join reg_periksa inner join diagnosa_pasien inner join kamar_inap "+
                        ...
                        "diagnosa_pasien.status='Ralan' and diagnosa_pasien.prioritas='1' and kamar_inap.tgl_keluar between ? and ? "+
                        "and diagnosa_pasien.kd_penyakit=? group by diagnosa_pasien.no_rawat");    
                   try {
                        ps2.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                        ps2.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                   ...
                   ps3=koneksi.prepareStatement("select diagnosa_pasien.no_rawat as jumlah from diagnosa_pasien inner join reg_periksa inner join pasien_mati "+
                       ...
                       "and pasien_mati.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.no_rawat=kamar_inap.no_rawat where diagnosa_pasien.status='Ralan' and "+
                   ...
                   ps5=koneksi.prepareStatement("select diagnosa_pasien.no_rawat as jumlah from diagnosa_pasien inner join reg_periksa "+
                       "inner join pasien inner join kamar_inap on reg_periksa.no_rawat=diagnosa_pasien.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                       "and reg_periksa.no_rawat=kamar_inap.no_rawat where diagnosa_pasien.status='Ralan' and diagnosa_pasien.prioritas='1' and pasien.jk='L' "+
                   ...
                   ps6=koneksi.prepareStatement("select diagnosa_pasien.no_rawat as jumlah from diagnosa_pasien inner join reg_periksa "+
                       "inner join pasien inner join kamar_inap on reg_periksa.no_rawat=diagnosa_pasien.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                       "and reg_periksa.no_rawat=kamar_inap.no_rawat where diagnosa_pasien.status='Ralan' and diagnosa_pasien.prioritas='1' and pasien.jk='P' "+
                       "and kamar_inap.tgl_keluar between ? and ? and diagnosa_pasien.kd_penyakit=? group by diagnosa_pasien.no_rawat");
                   try{
                       ps6.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                        ps6.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                   ...
                   label9.setText("Record : "+tabMode2.getRowCount()+" dari "+rs.getString("jml"));
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
            } finally{
