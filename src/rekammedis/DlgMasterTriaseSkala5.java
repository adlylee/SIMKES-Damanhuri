 ...
 * @author dosen
 */
public class DlgMasterTriaseSkala5 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgMasterTriaseSkala5(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgMasterTriaseSkala5 dialog = new DlgMasterTriaseSkala5(new javax.swing.JFrame(), true);
