 ...
 * @author dosen
 */
public class DlgMasterTriaseSkala4 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgMasterTriaseSkala4(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgMasterTriaseSkala4 dialog = new DlgMasterTriaseSkala4(new javax.swing.JFrame(), true);
