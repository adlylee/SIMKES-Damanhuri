    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "a.diagnosa_keperawatan,a.intervensi,a.diagnosis,a.tindakan,a.keterangan,a.kd_dokter,dokter.nm_dokter,a.kd_petugas,petugas.nama,a.jam "
                    ...
                    + "pasien.nm_pasien like ?) order by a.tanggal");
            try {
