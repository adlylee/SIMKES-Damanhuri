 ...
 * @author dosen
 */
public class DlgMasterTriaseSkala1 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgMasterTriaseSkala1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgMasterTriaseSkala1 dialog = new DlgMasterTriaseSkala1(new javax.swing.JFrame(), true);
