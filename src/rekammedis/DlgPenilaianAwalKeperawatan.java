 ...
 * @author perpustakaan
 */
public final class DlgPenilaianAwalKeperawatan extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DlgPenilaianAwalKeperawatan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        KetLapor.setVisible(false);
        jLabel64.setVisible(false);
        KetDokter.setVisible(false);
    }
    ...
    private void initComponents() {
        ...
        Alergi1 = new widget.TextArea();
        scrollPane14 = new widget.ScrollPane();
        Alergi2 = new widget.TextArea();
        jLabel39 = new widget.Label();
        jLabel40 = new widget.Label();
        jSeparator11 = new javax.swing.JSeparator();
        scrollPane16 = new widget.ScrollPane();
        Alergi4 = new widget.TextArea();
        ...
        Alergi3 = new widget.TextArea();
        KetSG3 = new widget.TextBox();
        jLabel46 = new widget.Label();
        SG4 = new widget.ComboBox();
        KetSG4 = new widget.TextBox();
        ...
        internalFrame1.setPreferredSize(new java.awt.Dimension(938, 761));
        ...
        BtnDokter.setBounds(356, 40, 28, 23);
        ...
        TglLahir.setBounds(633, 10, 80, 23);

        jLabel9.setText("Riwayat Pengobatan :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(0, 210, 130, 23);

        Jk.setEditable(false);
        Jk.setHighlighter(null);
        Jk.setName("Jk"); // NOI18N
        FormInput.add(Jk);
        Jk.setBounds(753, 10, 80, 23);
        ...
        label11.setBounds(393, 40, 57, 23);
        ...
        jLabel12.setBounds(0, 520, 50, 23);
        ...
        FormInput.add(BB);
        BB.setBounds(55, 520, 60, 23);

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel13.setText("Kg");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(120, 520, 50, 23);
        ...
        FormInput.add(TB);
        TB.setBounds(245, 520, 60, 23);

        jLabel15.setText("TB :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(190, 520, 50, 23);

        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel16.setText("x/menit");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(310, 490, 50, 23);
        ...
        FormInput.add(Nadi);
        Nadi.setBounds(245, 490, 60, 23);

        jLabel17.setText("Nadi :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(190, 490, 50, 23);

        jLabel18.setText("Suhu :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(610, 490, 50, 23);
        ...
        FormInput.add(Suhu);
        Suhu.setBounds(665, 490, 60, 23);

        jLabel22.setText("TD :");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(0, 490, 50, 23);
        ...
        FormInput.add(TD);
        TD.setBounds(55, 490, 60, 23);

        jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel20.setText("°C");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(730, 490, 50, 23);

        jLabel23.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel23.setText("mmHg");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(120, 490, 50, 23);

        jLabel24.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel24.setText(" cm");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(310, 520, 50, 23);

        jLabel25.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel25.setText("x/menit");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(530, 490, 50, 23);
        ...
        FormInput.add(RR);
        RR.setBounds(465, 490, 60, 23);

        jLabel26.setText("Pernafasan :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(390, 490, 70, 23);

        jLabel14.setText("BMI :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(390, 520, 70, 23);
        ...
        FormInput.add(BMI);
        BMI.setBounds(465, 520, 60, 23);

        jLabel27.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel27.setText("Kg/m²");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(530, 520, 50, 23);
        ...
        jLabel37.setBounds(0, 160, 130, 23);

        jLabel43.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel43.setText("2. Apakah nafsu makan berkurang karena tidak nafsu makan ?");
        jLabel43.setName("jLabel43"); // NOI18N
        FormInput.add(jLabel43);
        jLabel43.setBounds(10, 620, 460, 23);

        jLabel50.setText("Prothesa :");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput.add(jLabel50);
        jLabel50.setBounds(490, 1930, 60, 23);

        jLabel52.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel52.setText("PENILAIAN TINGKAT NYERI");
        jLabel52.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(10, 930, 380, 23);
        ...
        jLabel53.setText("PEMERIKSAAN FISIK DAN SKRINNING GIZI");
        jLabel53.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel53.setName("jLabel53"); // NOI18N
        FormInput.add(jLabel53);
        jLabel53.setBounds(10, 460, 290, 20);
        ...
        scrollPane1.setBounds(135, 110, 300, 38);

        jLabel30.setText("Keluhan Utama :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(0, 110, 130, 20);

        jLabel31.setText("Riwayat Penyakit Dahulu :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(465, 160, 140, 23);
        ...
        scrollPane3.setBounds(610, 210, 300, 38);

        jLabel32.setText("Riwayat Penyakit Keluarga :");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(465, 210, 140, 23);
        ...
        scrollPane4.setBounds(135, 210, 300, 38);
        ...
        AlatBantu.setBounds(140, 1930, 90, 23);
        ...
        KetBantu.setBounds(230, 1930, 220, 23);

        jLabel54.setText("Hubungan pasien dengan anggota keluarga :");
        jLabel54.setName("jLabel54"); // NOI18N
        FormInput.add(jLabel54);
        jLabel54.setBounds(0, 410, 240, 23);
        ...
        Prothesa.setBounds(560, 1930, 90, 23);
        ...
        KetProthesa.setBounds(650, 1930, 220, 23);

        jLabel55.setText("Alat Bantu :");
        jLabel55.setName("jLabel55"); // NOI18N
        FormInput.add(jLabel55);
        jLabel55.setBounds(20, 1930, 120, 23);
        ...
        FormInput.add(ADL);
        ADL.setBounds(740, 1960, 130, 23);

        jLabel57.setText("Aktivitas Kehidupan Sehari-hari ( ADL ) :");
        jLabel57.setName("jLabel57"); // NOI18N
        FormInput.add(jLabel57);
        jLabel57.setBounds(460, 1960, 280, 23);

        StatusPsiko.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Stabil", "Gelisah", "Tenang", "Cemas", "Takut", "Marah", "Sedih", "Percobaan bunuh diri", "Halusinasi", "Lain-lain" }));
        StatusPsiko.setName("StatusPsiko"); // NOI18N
        StatusPsiko.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                StatusPsikoItemStateChanged(evt);
            }
        });
        ...
        StatusPsiko.setBounds(465, 410, 220, 23);
        ...
        KetPsiko.setBounds(690, 410, 220, 23);

        jLabel58.setText("Edukasi diberikan kepada :");
        jLabel58.setName("jLabel58"); // NOI18N
        FormInput.add(jLabel58);
        jLabel58.setBounds(170, 1890, 140, 23);
        ...
        HubunganKeluarga.setBounds(245, 410, 100, 23);

        jLabel59.setText("Status Sosial dan ekonomi :");
        jLabel59.setName("jLabel59"); // NOI18N
        FormInput.add(jLabel59);
        jLabel59.setBounds(0, 1810, 176, 23);
        ...
        TinggalDengan.setBounds(440, 1830, 110, 23);
        ...
        KetTinggal.setBounds(560, 1830, 85, 23);

        jLabel60.setText("b. Tinggal dengan :");
        jLabel60.setName("jLabel60"); // NOI18N
        FormInput.add(jLabel60);
        jLabel60.setBounds(340, 1830, 100, 23);
        ...
        Ekonomi.setBounds(720, 1830, 84, 23);

        jLabel61.setText("c. Ekonomi :");
        jLabel61.setName("jLabel61"); // NOI18N
        FormInput.add(jLabel61);
        jLabel61.setBounds(640, 1830, 71, 23);
        ...
        Edukasi.setBounds(320, 1890, 110, 23);
        ...
        KetEdukasi.setBounds(430, 1890, 370, 23);

        jLabel64.setText("Jam  :");
        jLabel64.setName("jLabel64"); // NOI18N
        FormInput.add(jLabel64);
        jLabel64.setBounds(610, 1050, 50, 23);

        jLabel65.setText("1. Tidak seimbang / sempoyongan / limbung :");
        jLabel65.setName("jLabel65"); // NOI18N
        FormInput.add(jLabel65);
        jLabel65.setBounds(0, 820, 240, 23);

        jLabel66.setText("2. Menggunakan alat bantu (kruk, tripot, kursi roda, orang lain) :");
        jLabel66.setName("jLabel66"); // NOI18N
        FormInput.add(jLabel66);
        jLabel66.setBounds(325, 820, 330, 23);

        Lapor.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        Lapor.setName("Lapor"); // NOI18N
        Lapor.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                LaporItemStateChanged(evt);
            }
        });
        ...
        FormInput.add(BJM);
        BJM.setBounds(660, 820, 80, 23);

        jLabel67.setText("Menyebar :");
        jLabel67.setName("jLabel67"); // NOI18N
        FormInput.add(jLabel67);
        jLabel67.setBounds(710, 2080, 79, 23);
        ...
        FormInput.add(Hasil);
        Hasil.setBounds(55, 880, 293, 23);

        jLabel68.setText("Hasil :");
        jLabel68.setName("jLabel68"); // NOI18N
        FormInput.add(jLabel68);
        jLabel68.setBounds(0, 880, 50, 23);
        ...
        FormInput.add(SG2);
        SG2.setBounds(460, 620, 160, 23);

        KetLapor.setFocusTraversalPolicyProvider(true);
        KetLapor.setName("KetLapor"); // NOI18N
        KetLapor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KetLaporActionPerformed(evt);
            }
        });
        ...
        KetLapor.setBounds(690, 880, 60, 23);

        jLabel69.setText("Nilai :");
        jLabel69.setName("jLabel69"); // NOI18N
        FormInput.add(jLabel69);
        jLabel69.setBounds(630, 620, 55, 23);

        jLabel70.setText("b. Menopang saat akan duduk,  memegang pinggiran kursi atau meja / benda lain sebagai penopang :");
        jLabel70.setName("jLabel70"); // NOI18N
        FormInput.add(jLabel70);
        jLabel70.setBounds(10, 850, 490, 23);
        ...
        FormInput.add(SG1);
        SG1.setBounds(460, 590, 160, 23);

        jLabel72.setText("a. Cara Berjalan :");
        jLabel72.setName("jLabel72"); // NOI18N
        FormInput.add(jLabel72);
        jLabel72.setBounds(10, 790, 90, 23);
        ...
        FormInput.add(MSA);
        MSA.setBounds(510, 850, 80, 23);

        jLabel73.setText("Total Skor :");
        jLabel73.setName("jLabel73"); // NOI18N
        FormInput.add(jLabel73);
        jLabel73.setBounds(630, 650, 55, 23);

        jLabel75.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel75.setText("1. Apakah ada penurunan berat badan yang tidak diinginkan dalam 6 bulan terakhir ?");
        jLabel75.setName("jLabel75"); // NOI18N
        FormInput.add(jLabel75);
        jLabel75.setBounds(10, 590, 460, 23);

        Nyeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak Ada Nyeri", "Nyeri Kronis", "Nyeri Akut" }));
        ...
        FormInput.add(Nyeri);
        Nyeri.setBounds(465, 960, 130, 23);
        ...
        Provokes.setBounds(590, 2000, 130, 23);
        ...
        KetProvokes.setBounds(720, 2000, 146, 23);

        jLabel80.setText("Penyebab :");
        jLabel80.setName("jLabel80"); // NOI18N
        FormInput.add(jLabel80);
        jLabel80.setBounds(530, 2000, 60, 23);
        ...
        Quality.setBounds(450, 2030, 140, 23);
        ...
        KetQuality.setBounds(590, 2030, 281, 23);

        jLabel81.setText("Kualitas :");
        jLabel81.setName("jLabel81"); // NOI18N
        FormInput.add(jLabel81);
        jLabel81.setBounds(390, 2030, 55, 23);

        jLabel82.setText("Wilayah :");
        jLabel82.setName("jLabel82"); // NOI18N
        FormInput.add(jLabel82);
        jLabel82.setBounds(390, 2060, 55, 23);
        ...
        Lokasi.setBounds(465, 990, 280, 23);

        jLabel83.setText("Lokasi nyeri :");
        jLabel83.setName("jLabel83"); // NOI18N
        FormInput.add(jLabel83);
        jLabel83.setBounds(370, 990, 90, 23);
        ...
        Menyebar.setBounds(790, 2080, 80, 23);

        jLabel84.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel84.setText("Menit");
        jLabel84.setName("jLabel84"); // NOI18N
        FormInput.add(jLabel84);
        jLabel84.setBounds(830, 2110, 35, 23);

        jLabel85.setText("Skala Nyeri :");
        jLabel85.setName("jLabel85"); // NOI18N
        FormInput.add(jLabel85);
        jLabel85.setBounds(605, 960, 80, 23);
        ...
        SkalaNyeri.setBounds(690, 960, 50, 23);

        jLabel86.setText("Diberitahukan pada dokter ?");
        jLabel86.setName("jLabel86"); // NOI18N
        FormInput.add(jLabel86);
        jLabel86.setBounds(365, 1050, 150, 23);
        ...
        Durasi.setBounds(740, 2110, 90, 23);

        jLabel87.setText("Waktu / Durasi :");
        jLabel87.setName("jLabel87"); // NOI18N
        FormInput.add(jLabel87);
        jLabel87.setBounds(640, 2110, 90, 23);

        jLabel88.setText("Severity :");
        jLabel88.setName("jLabel88"); // NOI18N
        FormInput.add(jLabel88);
        jLabel88.setBounds(390, 2110, 55, 23);

        NyeriHilang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Minum Obat", "Istirahat", "Medengar Musik", "Berubah posisi / tidur", "Lain-lainnya, sebutkan", " " }));
        ...
        NyeriHilang.setBounds(465, 1020, 130, 23);
        ...
        PadaDokter.setBounds(520, 1050, 75, 23);
        ...
        KetDokter.setBounds(665, 1050, 80, 23);

        jLabel92.setText("Nilai :");
        jLabel92.setName("jLabel92"); // NOI18N
        FormInput.add(jLabel92);
        jLabel92.setBounds(630, 590, 55, 23);
        ...
        TglAsuhan.setBounds(453, 40, 130, 23);

        jLabel28.setText("GCS(E,V,M) :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(810, 1860, 90, 23);
        ...
        FormInput.add(GCS);
        GCS.setBounds(900, 1860, 60, 23);

        jLabel94.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel94.setText("RIWAYAT KESEHATAN");
        jLabel94.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel94.setName("jLabel94"); // NOI18N
        FormInput.add(jLabel94);
        jLabel94.setBounds(10, 80, 180, 23);

        jLabel51.setText("Cacat Fisik :");
        jLabel51.setName("jLabel51"); // NOI18N
        FormInput.add(jLabel51);
        jLabel51.setBounds(20, 1960, 120, 23);
        ...
        StatusBudaya.setBounds(320, 1860, 110, 23);
        ...
        KetBudaya.setBounds(430, 1860, 370, 23);

        jLabel96.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel96.setText("RIWAYAT PSIKOSOSIAL");
        jLabel96.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel96.setName("jLabel96"); // NOI18N
        FormInput.add(jLabel96);
        jLabel96.setBounds(10, 380, 380, 23);

        jLabel97.setText("Dilaporkan kepada dokter ?");
        jLabel97.setName("jLabel97"); // NOI18N
        FormInput.add(jLabel97);
        jLabel97.setBounds(360, 880, 140, 23);

        jLabel63.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel63.setText("PENILAIAN RESIKO JATUH");
        jLabel63.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel63.setName("jLabel63"); // NOI18N
        FormInput.add(jLabel63);
        jLabel63.setBounds(10, 760, 380, 23);
        ...
        jSeparator1.setBounds(10, 75, 1210, 1);
        ...
        jSeparator3.setBounds(10, 370, 1210, 1);
        ...
        jSeparator5.setBounds(10, 750, 1210, 1);
        ...
        jSeparator6.setBounds(10, 920, 1210, 1);
        ...
        jSeparator7.setBounds(10, 1110, 1210, 1);
        ...
        jSeparator8.setBounds(30, 2020, 880, 1);

        jLabel74.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel74.setText("ANALISA MASALAH KEPERAWATAN / KEBIDANAN");
        jLabel74.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel74.setName("jLabel74"); // NOI18N
        FormInput.add(jLabel74);
        jLabel74.setBounds(10, 1120, 380, 23);
        ...
        PanelWall.setBounds(30, 960, 320, 130);
        ...
        jSeparator9.setBounds(365, 960, 1, 140);

        jLabel71.setText("Jam dilaporkan :");
        jLabel71.setName("jLabel71"); // NOI18N
        FormInput.add(jLabel71);
        jLabel71.setBounds(595, 880, 90, 23);
        ...
        jSeparator10.setBounds(0, 1970, 880, 1);
        ...
        Scroll6.setBounds(10, 1150, 400, 143);

        label12.setText("Key Word :");
        label12.setName("label12"); // NOI18N
        label12.setPreferredSize(new java.awt.Dimension(60, 23));
        FormInput.add(label12);
        label12.setBounds(10, 1300, 60, 23);
        ...
        BtnAllMasalah.setBounds(330, 1300, 28, 23);
        ...
        BtnCariMasalah.setBounds(300, 1300, 28, 23);
        ...
        TabRencanaKeperawatan.setBounds(420, 1150, 420, 143);
        ...
        TCariMasalah.setBounds(75, 1300, 215, 23);
        ...
        BtnTambahRencana.setBounds(800, 1300, 28, 23);
        ...
        BtnAllRencana.setBounds(770, 1300, 28, 23);
        ...
        BtnCariRencana.setBounds(740, 1300, 28, 23);

        label13.setText("Key Word :");
        label13.setName("label13"); // NOI18N
        label13.setPreferredSize(new java.awt.Dimension(60, 23));
        FormInput.add(label13);
        label13.setBounds(430, 1300, 60, 23);
        ...
        TCariRencana.setBounds(495, 1300, 235, 23);
        ...
        scrollPane7.setBounds(610, 110, 300, 38);

        jLabel35.setText("Riwayat Penyakit Sekarang :");
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(465, 110, 140, 23);
        ...
        scrollPane9.setViewportView(RPD);

        FormInput.add(scrollPane9);
        scrollPane9.setBounds(610, 160, 300, 38);
        ...
        scrollPane12.setViewportView(Alergi);

        FormInput.add(scrollPane12);
        scrollPane12.setBounds(135, 160, 300, 38);

        scrollPane13.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane13.setName("scrollPane13"); // NOI18N

        Alergi1.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Alergi1.setColumns(20);
        Alergi1.setRows(5);
        ...
        scrollPane13.setViewportView(Alergi1);

        FormInput.add(scrollPane13);
        scrollPane13.setBounds(135, 270, 300, 38);

        scrollPane14.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane14.setName("scrollPane14"); // NOI18N

        Alergi2.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Alergi2.setColumns(20);
        Alergi2.setRows(5);
        ...
        scrollPane14.setViewportView(Alergi2);

        FormInput.add(scrollPane14);
        scrollPane14.setBounds(135, 320, 300, 38);

        jLabel39.setText("Pemeriksaan :");
        jLabel39.setToolTipText("");
        jLabel39.setName("jLabel39"); // NOI18N
        FormInput.add(jLabel39);
        jLabel39.setBounds(0, 270, 130, 23);

        jLabel40.setText("Diagnosa :");
        jLabel40.setToolTipText("");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(0, 320, 130, 23);
        ...
        jSeparator11.setBounds(10, 260, 1210, 1);

        scrollPane16.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane16.setName("scrollPane16"); // NOI18N

        Alergi4.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Alergi4.setColumns(20);
        Alergi4.setRows(5);
        ...
        scrollPane16.setViewportView(Alergi4);

        FormInput.add(scrollPane16);
        scrollPane16.setBounds(610, 320, 300, 38);

        jLabel42.setText("Planning :");
        jLabel42.setToolTipText("");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(465, 270, 140, 23);

        jLabel44.setText("Tindakan :");
        jLabel44.setToolTipText("");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(465, 320, 140, 23);
        ...
        jSeparator12.setBounds(10, 450, 1210, 1);
        ...
        jSeparator13.setBounds(10, 550, 1210, 1);

        jLabel78.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel78.setText("Berdasarkan Malnutrition Screening Tooll (MST)");
        jLabel78.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel78.setName("jLabel78"); // NOI18N
        FormInput.add(jLabel78);
        jLabel78.setBounds(10, 560, 290, 23);

        jLabel79.setText("Skrining nyeri :");
        jLabel79.setName("jLabel79"); // NOI18N
        FormInput.add(jLabel79);
        jLabel79.setBounds(370, 960, 90, 23);
        ...
        Nilai1.setBounds(690, 590, 50, 23);
        ...
        Nilai2.setBounds(690, 620, 50, 23);

        jLabel45.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel45.setText("3. Pasien dengan diagnosa khusus ?");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(10, 680, 190, 23);
        ...
        FormInput.add(SG3);
        SG3.setBounds(200, 680, 140, 23);

        scrollPane15.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane15.setName("scrollPane15"); // NOI18N

        Alergi3.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Alergi3.setColumns(20);
        Alergi3.setRows(5);
        ...
        scrollPane15.setViewportView(Alergi3);

        FormInput.add(scrollPane15);
        scrollPane15.setBounds(610, 270, 300, 38);

        KetSG3.setFocusTraversalPolicyProvider(true);
        KetSG3.setName("KetSG3"); // NOI18N
        KetSG3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KetSG3KeyPressed(evt);
            }
        });
        FormInput.add(KetSG3);
        KetSG3.setBounds(350, 680, 390, 23);

        jLabel46.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel46.setText("Status Fungsional");
        jLabel46.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput.add(jLabel46);
        jLabel46.setBounds(80, 710, 110, 23);

        SG4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Mandiri", "Ketergantungan total", "Perlu bantuan", "Alat Bantu" }));
        ...
        FormInput.add(SG4);
        SG4.setBounds(200, 710, 140, 23);

        KetSG4.setFocusTraversalPolicyProvider(true);
        KetSG4.setName("KetSG4"); // NOI18N
        KetSG4.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KetSG4KeyPressed(evt);
            }
        });
        FormInput.add(KetSG4);
        KetSG4.setBounds(350, 710, 390, 23);
        ...
        internalFrame3.getAccessibleContext().setAccessibleParent(TabRawat);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRM.getText().trim().equals("")) {
            ...
            if (Sequel.menyimpantf("penilaian_awal_keperawatan_ralan", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 57, new String[]{
                ...
                KetEdukasi.getText(), ATS.getSelectedItem().toString(), BJM.getSelectedItem().toString(), MSA.getSelectedItem().toString(), Hasil.getSelectedItem().toString(), Lapor.getSelectedItem().toString(), TglAsuhan.getSelectedItem().toString().substring(10, 19),
                //                KetLapor.getText(),
                SG1.getSelectedItem().toString(), Nilai1.getText(), SG2.getSelectedItem().toString(), Nilai2.getText(), TotalHasil.getText(), Nyeri.getSelectedItem().toString(),
                ...
                Durasi.getText(), NyeriHilang.getSelectedItem().toString(), KetNyeri.getText(), PadaDokter.getSelectedItem().toString(),
                //                KetDokter.getText(), 
                TglAsuhan.getSelectedItem().toString().substring(10, 19), Rencana.getText(), KdPetugas.getText()
            }) == true) {
...
//        Valid.pindah2(evt,RPD,Alergi);
    ...
    private void BtnTambahMasalahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahMasalahActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        DlgRencanaKeperawatan form = new DlgRencanaKeperawatan(null, false);
        form.isCek();
    ...
    private void SG1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_SG1ItemStateChanged
        if (SG1.getSelectedIndex() == 0) {
            Nilai1.setText("0");
        } else if (SG1.getSelectedIndex() == 1) {
            Nilai1.setText("2");
        } else if (SG1.getSelectedIndex() == 2) {
            Nilai1.setText("1");
        } else if (SG1.getSelectedIndex() == 3) {
            Nilai1.setText("2");
        } else if (SG1.getSelectedIndex() == 4) {
            Nilai1.setText("3");
        } else if (SG1.getSelectedIndex() == 5) {
            Nilai1.setText("4");
        }
...
//        TotalHasil.setText("" + (Integer.parseInt(Nilai1.getText().toString()) + Integer.parseInt(Nilai2.getText().toString())));
        TotalHasil.setText(Valid.SetAngka(Valid.SetAngka(Nilai1.getText()) + Valid.SetAngka(Nilai2.getText())) + "");
    ...
    private void SG2ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_SG2ItemStateChanged
        if (SG2.getSelectedIndex() == 0) {
            Nilai2.setText("0");
        } else if (SG2.getSelectedIndex() == 1) {
            Nilai2.setText("1");
        }
...
//            TotalHasil.setText("" + (Integer.parseInt(Nilai1.getText().toString()) + Integer.parseInt(Nilai2.getText().toString())));
    ...
    private void StatusPsikoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_StatusPsikoItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_StatusPsikoItemStateChanged
    ...
    private void KetSG3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KetSG3KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KetSG3KeyPressed
    ...
    private void KetSG4KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KetSG4KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KetSG4KeyPressed
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            Valid.MyReport("rptCetakPenilaianAwalKeperawatanRalan.jrxml", "report", "::[ Laporan Penilaian Awal Keperawatan Ralan ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,penilaian_awal_keperawatan_ralan.tanggal,"
                    + "penilaian_awal_keperawatan_ralan.informasi,penilaian_awal_keperawatan_ralan.td,penilaian_awal_keperawatan_ralan.nadi,penilaian_awal_keperawatan_ralan.rr,penilaian_awal_keperawatan_ralan.suhu,penilaian_awal_keperawatan_ralan.bb,penilaian_awal_keperawatan_ralan.tb,"
                    + "penilaian_awal_keperawatan_ralan.nadi,penilaian_awal_keperawatan_ralan.rr,penilaian_awal_keperawatan_ralan.suhu,penilaian_awal_keperawatan_ralan.gcs,penilaian_awal_keperawatan_ralan.bb,penilaian_awal_keperawatan_ralan.tb,penilaian_awal_keperawatan_ralan.bmi,penilaian_awal_keperawatan_ralan.keluhan_utama,"
                    + "penilaian_awal_keperawatan_ralan.rpd,penilaian_awal_keperawatan_ralan.rpk,penilaian_awal_keperawatan_ralan.rpo,penilaian_awal_keperawatan_ralan.alergi,penilaian_awal_keperawatan_ralan.alat_bantu,penilaian_awal_keperawatan_ralan.ket_bantu,penilaian_awal_keperawatan_ralan.prothesa,"
    ...
    private void KetLaporActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KetLaporActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_KetLaporActionPerformed

    private void LaporItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_LaporItemStateChanged
        if (Lapor.getSelectedIndex() == 0) {
            jLabel71.setVisible(false);
            KetLapor.setVisible(false);
        } else {
            jLabel71.setVisible(true);
            KetLapor.setVisible(true);
        }
    }//GEN-LAST:event_LaporItemStateChanged

    private void PadaDokterItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_PadaDokterItemStateChanged
        if (PadaDokter.getSelectedIndex() == 0) {
            jLabel64.setVisible(false);
            KetDokter.setVisible(false);
        } else {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPenilaianAwalKeperawatan dialog = new DlgPenilaianAwalKeperawatan(new javax.swing.JFrame(), true);
    ...
    private widget.TextArea Alergi1;
    private widget.TextArea Alergi2;
    private widget.TextArea Alergi3;
    private widget.TextArea Alergi4;
    ...
    private widget.TextBox KetSG3;
    private widget.TextBox KetSG4;
...
//            Nilai3.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 45).toString());
            Nilai1.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 45).toString());
            SG2.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 46).toString());
//            Nilai4.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 47).toString());
            Nilai2.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 47).toString());
...
//        BtnTambahRencana.setEnabled(akses.getmaster_rencana_keperawatan());  
    ...
    private void tampilRencana2() {
        try {
            ...
            try {
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabModeRencana.addRow(new Object[]{false, rs.getString(2), rs.getString(3)});
                }
            } catch (Exception e) {
                System.out.println("Notifikasi 1 : " + e);
            } finally {
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_awal_keperawatan_ralan", "no_rawat=?", "no_rawat=?,tanggal=?,informasi=?,td=?,nadi=?,rr=?,suhu=?,gcs=?,bb=?,tb=?,bmi=?,keluhan_utama=?,rpd=?,rpk=?,rpo=?,alergi=?,alat_bantu=?,ket_bantu=?,prothesa=?,ket_pro=?,adl=?,status_psiko=?,ket_psiko=?,hub_keluarga=?,tinggal_dengan=?,ket_tinggal=?,ekonomi=?,budaya=?,ket_budaya=?,edukasi=?,ket_edukasi=?,berjalan_a=?,berjalan_b=?,berjalan_c=?,hasil=?,lapor=?,ket_lapor=?,sg1=?,nilai1=?,sg2=?,nilai2=?,total_hasil=?,nyeri=?,provokes=?,ket_provokes=?,quality=?,ket_quality=?,lokasi=?,menyebar=?,skala_nyeri=?,durasi=?,nyeri_hilang=?,ket_nyeri=?,pada_dokter=?,ket_dokter=?,rencana=?,nip=?", 58, new String[]{
            ...
            SG1.getSelectedItem().toString(), Nilai1.getText(), SG2.getSelectedItem().toString(), Nilai2.getText(), TotalHasil.getText(), Nyeri.getSelectedItem().toString(),
            Provokes.getSelectedItem().toString(), KetProvokes.getText(), Quality.getSelectedItem().toString(), KetQuality.getText(), Lokasi.getText(), Menyebar.getSelectedItem().toString(), SkalaNyeri.getSelectedItem().toString(),
            Durasi.getText(), NyeriHilang.getSelectedItem().toString(), KetNyeri.getText(), PadaDokter.getSelectedItem().toString(), TglAsuhan.getSelectedItem().toString().substring(10, 19), Rencana.getText(), KdPetugas.getText(), tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString()
        }) == true) {
            Sequel.meghapus("penilaian_awal_keperawatan_ralan_masalah", "no_rawat", tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString());
            for (i = 0; i < tbMasalahKeperawatan.getRowCount(); i++) {
                if (tbMasalahKeperawatan.getValueAt(i, 0).toString().equals("true")) {
