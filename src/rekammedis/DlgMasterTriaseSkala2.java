 ...
 * @author dosen
 */
public class DlgMasterTriaseSkala2 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgMasterTriaseSkala2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgMasterTriaseSkala2 dialog = new DlgMasterTriaseSkala2(new javax.swing.JFrame(), true);
