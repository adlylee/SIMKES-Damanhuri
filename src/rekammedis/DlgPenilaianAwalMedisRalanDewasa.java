 ...
 * @author perpustakaan
 */
public final class DlgPenilaianAwalMedisRalanDewasa extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPenilaianAwalMedisRalanDewasa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Diagnosis.setDocument(new batasInput((int)3000).getKata(Diagnosis));
        Terapi.setDocument(new batasInput((int)500).getKata(Terapi));
        Tindakan.setDocument(new batasInput((int)5000).getKata(Tindakan));
//        Konsul.setDocument(new batasInput((int)1000).getKata(Konsul));
    ...
    private void initComponents() {
        ...
        jLabel16.setBounds(370, 260, 50, 23);
        ...
        FormInput.add(Nadi);
        Nadi.setBounds(322, 260, 45, 23);

        jLabel17.setText("Nadi :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(278, 260, 40, 23);
        ...
        jLabel22.setBounds(0, 260, 127, 23);
        ...
        jLabel23.setBounds(210, 260, 50, 23);
        ...
        jLabel25.setBounds(570, 290, 50, 23);
        ...
        FormInput.add(RR);
        RR.setBounds(520, 290, 45, 23);

        jLabel26.setText("RR :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(480, 290, 40, 23);
        ...
        Anamnesis.setBounds(644, 40, 120, 23);
        ...
        jLabel94.setText("PEMERIKSAAN FISIK");
        ...
        jLabel39.setText("Dada :");
        jLabel39.setName("jLabel39"); // NOI18N
        FormInput.add(jLabel39);
        jLabel39.setBounds(250, 290, 95, 23);
        ...
        FormInput.add(Mata);
        Mata.setBounds(125, 320, 120, 23);

        jLabel40.setText("Kepala :");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(0, 290, 120, 23);
        ...
        FormInput.add(Dada);
        Dada.setBounds(350, 290, 120, 23);

        jLabel41.setText("Mata :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(0, 320, 120, 23);
        ...
        Kepala.setBounds(125, 290, 120, 23);

        jLabel44.setText("Gigi & Mulut :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(0, 380, 120, 23);
        ...
        FormInput.add(Gigi);
        Gigi.setBounds(125, 380, 120, 23);

        jLabel45.setText("THT :");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(0, 350, 120, 23);
        ...
        FormInput.add(THT);
        THT.setBounds(125, 350, 120, 23);

        jLabel46.setText("Leher :");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput.add(jLabel46);
        jLabel46.setBounds(0, 410, 120, 23);
        ...
        FormInput.add(Leher);
        Leher.setBounds(125, 410, 120, 23);

        jLabel49.setText("Abdomen :");
        jLabel49.setName("jLabel49"); // NOI18N
        FormInput.add(jLabel49);
        jLabel49.setBounds(250, 320, 95, 23);
        ...
        Abdomen.setBounds(350, 320, 120, 23);

        jLabel50.setText("Punggung :");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput.add(jLabel50);
        jLabel50.setBounds(250, 350, 95, 23);
        ...
        Punggung.setBounds(350, 350, 120, 23);

        jLabel51.setText("Ekstremitas :");
        jLabel51.setName("jLabel51"); // NOI18N
        FormInput.add(jLabel51);
        jLabel51.setBounds(250, 410, 95, 23);
        ...
        Ekstremitas.setBounds(350, 410, 120, 23);

        jLabel52.setText("Genetalia :");
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(250, 380, 95, 23);
        ...
        Genetalia.setBounds(350, 380, 120, 23);
        ...
        jLabel99.setText("RIWAYAT KESEHATAN");
        ...
        jLabel100.setText("STATUS LOKALIS");
        ...
        scrollPane9.setViewportView(Diagnosis);
        ...
        scrollPane12.setViewportView(Terapi);
        ...
        scrollPane13.setViewportView(Tindakan);

        FormInput.add(scrollPane13);
        scrollPane13.setBounds(44, 1050, 810, 153);

        jLabel103.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel103.setText("TINDAKAN");
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-02-2023 10:26:44" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_medis_ralan","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",35,new String[]{
                    ...
                    KeluhanUtama.getText(),RPS.getText(),RPD.getText(),RPK.getText(),RPO.getText(),Alergi.getText(),Mata.getSelectedItem().toString(),GCS.getText(),Dada.getSelectedItem().toString(),TD.getText(),
                    ...
                    Leher.getSelectedItem().toString(),Abdomen.getSelectedItem().toString(),Punggung.getSelectedItem().toString(),Ekstremitas.getSelectedItem().toString(),Genetalia.getSelectedItem().toString(),KetFisik.getText(),
                    KetLokalis.getText(),Diagnosis.getText(),Terapi.getText(),Tindakan.getText()
//                    ,Konsul.getText()
                })==true){
                    emptTeks();
            }
...
//        Valid.pindah2(evt,KeluhanUtama,RPK);
    ...
    private void AbdomenKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_AbdomenKeyPressed
        Valid.pindah(evt,Leher,Punggung);
    ...
    private void EkstremitasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_EkstremitasKeyPressed
        Valid.pindah(evt,Punggung,Genetalia);
...
//        Valid.pindah2(evt,Diagnosis,Konsul);
    ...
    private void TglAsuhanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TglAsuhanKeyPressed
        Valid.pindah(evt,KeluhanUtama,Anamnesis);
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReport("rptCetakPenilaianAwalMedisRalan.jasper","report","::[ Laporan Penilaian Awal Medis Rawat Jalan ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ralan.tanggal,"+
                "penilaian_medis_ralan.kd_dokter,penilaian_medis_ralan.anamnesis,penilaian_medis_ralan.hubungan,penilaian_medis_ralan.keluhan_utama,penilaian_medis_ralan.rps,penilaian_medis_ralan.rpk,penilaian_medis_ralan.rpd,penilaian_medis_ralan.rpo,penilaian_medis_ralan.alergi,"+
                "penilaian_medis_ralan.keadaan,penilaian_medis_ralan.gcs,penilaian_medis_ralan.kesadaran,penilaian_medis_ralan.td,penilaian_medis_ralan.nadi,penilaian_medis_ralan.rr,penilaian_medis_ralan.suhu,penilaian_medis_ralan.spo,penilaian_medis_ralan.bb,penilaian_medis_ralan.tb,"+
                "penilaian_medis_ralan.kepala,penilaian_medis_ralan.gigi,penilaian_medis_ralan.tht,penilaian_medis_ralan.thoraks,penilaian_medis_ralan.abdomen,penilaian_medis_ralan.ekstremitas,penilaian_medis_ralan.genital,penilaian_medis_ralan.kulit,"+
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPenilaianAwalMedisRalanDewasa dialog = new DlgPenilaianAwalMedisRalanDewasa(new javax.swing.JFrame(), true);
...
//        Konsul.setText("");
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Mata.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),16).toString());
            GCS.setText(tbObat.getValueAt(tbObat.getSelectedRow(),17).toString());
            Dada.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),18).toString());
            ...
            Punggung.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),31).toString());
            Ekstremitas.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),32).toString());
            Genetalia.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),33).toString());
...
//            Konsul.setText(tbObat.getValueAt(tbObat.getSelectedRow(),39).toString());
    ...
    public void isCek(){
//        BtnSimpan.setEnabled(var.getpenilaian_awal_medis_ralan());
//        BtnHapus.setEnabled(var.getpenilaian_awal_medis_ralan());
//        BtnEdit.setEnabled(var.getpenilaian_awal_medis_ralan());
//        BtnEdit.setEnabled(var.getpenilaian_awal_medis_ralan());
        if(var.getjml2()>=1){
            KdDokter.setEditable(false);
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ralan","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpk=?,rpd=?,rpo=?,alergi=?,keadaan=?,gcs=?,kesadaran=?,td=?,nadi=?,rr=?,suhu=?,spo=?,bb=?,tb=?,kepala=?,gigi=?,tht=?,thoraks=?,abdomen=?,genital=?,ekstremitas=?,kulit=?,ket_fisik=?,ket_lokalis=?,penunjang=?,diagnosis=?,tata=?,konsulrujuk=?",36,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),KeluhanUtama.getText(),RPS.getText(),RPD.getText(),RPK.getText(),RPO.getText(),Alergi.getText(),Mata.getSelectedItem().toString(),GCS.getText(),Dada.getSelectedItem().toString(),TD.getText(),Nadi.getText(),
                RR.getText(),Suhu.getText(),SPO.getText(),BB.getText(),TB.getText(),Kepala.getSelectedItem().toString(),Gigi.getSelectedItem().toString(),THT.getSelectedItem().toString(),Leher.getSelectedItem().toString(),Abdomen.getSelectedItem().toString(),Punggung.getSelectedItem().toString(),Ekstremitas.getSelectedItem().toString(),Genetalia.getSelectedItem().toString(),KetFisik.getText(),KetLokalis.getText(),
                Diagnosis.getText(),Terapi.getText(),Tindakan.getText(),
//                Konsul.getText(),
                tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
            })==true){
               tampil();
