...
public class DlgPasien extends javax.swing.JDialog {
    ...
    private String kdkel = "", kdkec = "", kdkab = "", kdprop = "", klg = "SAUDARA", say = "", pengurutan = "", asalform = "", bulan = "", tahun = "", awalantahun = "", awalanbulan = "", posisitahun = "",
            ...
            kabupatenpj = "", propinsi = "", propinsipj = "", norm_stri;
...
//        NIP.setDocument(new batasInput((byte) 30).getKata(NIP));
    ...
    private void initComponents() {
        ...
        internalFrame3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(230, 235, 225)), "::[ Demografi Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("sansserif", 1, 12), new java.awt.Color(50, 70, 50))); // NOI18N
        ...
        internalFrame8.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(230, 235, 225)), "::[ Gabungkan Ke Nomor RM ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("sansserif", 1, 12), new java.awt.Color(70, 70, 70))); // NOI18N
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("sansserif", 1, 12), new java.awt.Color(70, 70, 70))); // NOI18N
    ...
    if (TNo.getText().trim().equals("")) {
        ...
        try {
            ...
            if (Sequel.menyimpantf2("pasien", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rekam Medis Pasien", 36, new String[]{
                TNo.getText(), TNm.getText().toUpperCase(), TKtp.getText(), CmbJk.getSelectedItem().toString().substring(0, 1), TTmp.getText(),
                ...
                kdsuku.getText(), kdbahasa.getText(), kdcacat.getText(), EMail.getText(), "-", kdprop, PropinsiPj.getText()
            }) == true) {
...
private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
    if (TNo.getText().trim().equals("")) {
        ...
        Sequel.mengedit("pasien", "no_rkm_medis=?", "no_rkm_medis=?,nm_pasien=?,no_ktp=?,jk=?,tmp_lahir=?,"
                ...
                new String[]{TNo.getText(), TNm.getText().toUpperCase(), TKtp.getText(), CmbJk.getSelectedItem().toString().substring(0, 1), TTmp.getText(),
                    ...
                    KabupatenPj.getText(), kdperusahaan.getText(), kdsuku.getText(), kdbahasa.getText(), kdcacat.getText(), EMail.getText(), "-",
...
private void KabupatenMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_KabupatenMouseMoved
    ...
    private void MnIdentitasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnIdentitasActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptRM1.jrxml", "report", "::[ Identitas Pasien ]::", "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    ...
                    + "and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab and suku_bangsa.id=pasien.suku_bangsa where pasien.no_rkm_medis='" + TNo.getText() + "' ", param);
            this.setCursor(Cursor.getDefaultCursor());
        }
    ...
    private void MnIdentitas4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnIdentitas4ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("kontakrs", var.getkontakrs());
            param.put("emailrs", var.getemailrs());
            param.put("petugas", var.getnamauser());
            param.put("logo", Sequel.cariGambar("select logo from setting"));
            Valid.MyReport("rptIdentitasPasien.jrxml", "report", "::[ Identitas Pasien ]::", "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
                    + "pasien.pnd, pasien.keluarga, pasien.namakeluarga,penjab.png_jawab,pasien.pekerjaanpj,"
                    + "concat(pasien.alamatpj,', ',pasien.kelurahanpj,', ',pasien.kecamatanpj,', ',pasien.kabupatenpj,', ',pasien.propinsipj) as alamatpj from pasien "
    ...
    private void MnLaporanRM3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanRM3ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("emailrs", var.getemailrs());
            param.put("logo", Sequel.cariGambar("select logo from setting"));
            Valid.MyReport("rptRM13.jrxml", "report", "::[ Identitas Pasien ]::", "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
                    + "pasien.pnd, pasien.keluarga, pasien.namakeluarga,penjab.png_jawab,pasien.pekerjaanpj,"
                    + "concat(pasien.alamatpj,', ',pasien.kelurahanpj,', ',pasien.kecamatanpj,', ',pasien.kabupatenpj,', ',pasien.propinsipj) as alamatpj from pasien "
...
//            NIP.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(), 30).toString());
    ...
    public void isCek() {
        ...
        MenuIdentitas.setVisible(false);//added
    }
    ...
    public void cekNomor() {
        ...
        String nomor = "";
        int regnomor;
        norm = Integer.parseInt(Sequel.cariIsi("select no_rkm_medis from set_no_rkm_medis"));
        norm1 = norm + 1;
        for (int k = 1; k <= 6 - String.valueOf(norm1).length(); k++) {
            nomor = nomor + "0";
        }
        norm_stri = nomor + String.valueOf(norm1);

        do {
            regnomor = Integer.parseInt(norm_stri) + 1;
            norm_stri = String.valueOf(regnomor);
            System.out.println(norm_stri);
        } while (Sequel.cariInteger("select no_rkm_medis from reg_periksa WHERE ?", norm_stri) > 0);
        System.out.println(norm_stri);
