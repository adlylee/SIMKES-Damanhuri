...
public class DlgPemberianDiet extends javax.swing.JDialog {
    ...
    public DlgPemberianDiet(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No.Rawat","Nama Pasien","Tgl Lahir","Kamar","Tanggal","Waktu","Diet"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Diet Harian Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(70, 70, 70))); // NOI18N
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-03-2023" }));
        ...
        cmbJam.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Pagi", "Siang", "Sore", "Malam", "Snack" }));
...
//                "GROUP BY no_rawat order by bangsal.nm_bangsal,diet.nama_diet",param);
//        }
    ...
    */
    ...
    public void tampil() {     
        try{
            ...
            ps=koneksi.prepareStatement("select detail_beri_diet.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, " +
                "concat(detail_beri_diet.kd_kamar,', ',bangsal.nm_bangsal),detail_beri_diet.tanggal,detail_beri_diet.waktu,diet.nama_diet, " +
                "concat('(',reg_periksa.umurdaftar,' ',reg_periksa.sttsumur,')'),pasien.tgl_lahir " +
                "from detail_beri_diet inner join reg_periksa inner join pasien inner join diet inner join kamar inner join bangsal " +
                "on detail_beri_diet.no_rawat=reg_periksa.no_rawat " +
                "and detail_beri_diet.kd_kamar=kamar.kd_kamar "+
                "and kamar.kd_bangsal=bangsal.kd_bangsal "+
                ...
                "order by bangsal.nm_bangsal,detail_beri_diet.kd_kamar,diet.nama_diet");
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        rs.getString(1),rs.getString(2)+", "+rs.getString(3)+" "+rs.getString(8),rs.getString(9),
                    ...
                    ps3=koneksi.prepareStatement(
                            ...
                            "on diagnosa_pasien.kd_penyakit=penyakit.kd_penyakit where no_rawat=?"
                            );
                    try {
                        ...
                        while(rs2.next()){
                            tabMode.addRow(new Object[]{
                                "","  "+rs2.getString("kd_penyakit")+" "+rs2.getString("nm_penyakit"),"","","","",""
                            });
                        }
                    } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            isRawat();            
            cmbJam.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString());
