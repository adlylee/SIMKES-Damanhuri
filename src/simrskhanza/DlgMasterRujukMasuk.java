...
import restore.DlgRestoreRujukMasuk;

/**
 *
 * @author dosen
 */
public final class DlgMasterRujukMasuk extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgMasterRujukMasuk(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,10);
        setSize(1045,1099);

        Object[] row={"P","No","Perujuk","Dokter Perujuk","Alamat"};
        ...
        TPerujuk.setDocument(new batasInput((byte)30).getKata(TPerujuk));
        TDokter.setDocument(new batasInput((byte)30).getKata(TDokter));
        TDokter.setDocument(new batasInput((byte)80).getKata(TDokter));
    ...
    private void initComponents() {
        ...
        panelGlass8.setPreferredSize(new java.awt.Dimension(44, 102));
        panelGlass8.setLayout(null);

        jLabel3.setText("Perujuk :");
        jLabel3.setName("jLabel3"); // NOI18N
        panelGlass8.add(jLabel3);
        jLabel3.setBounds(0, 12, 92, 23);

        TPerujuk.setName("TPerujuk"); // NOI18N
        TPerujuk.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TPerujukKeyPressed(evt);
            }
        });
        panelGlass8.add(TPerujuk);
        TPerujuk.setBounds(100, 10, 295, 23);

        TDokter.setFocusTraversalPolicyProvider(true);
        ...
        TDokter.setBounds(100, 40, 295, 23);

        jLabel4.setText("Dokter Perujuk :");
        jLabel4.setName("jLabel4"); // NOI18N
        panelGlass8.add(jLabel4);
        jLabel4.setBounds(0, 40, 92, 23);

        TAlamat.setFocusTraversalPolicyProvider(true);
        ...
        panelGlass8.add(TAlamat);
        TAlamat.setBounds(100, 70, 295, 23);
    ...
    private void TPerujukKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TPerujukKeyPressed
        Valid.pindah(evt,TCari,TDokter,TCari);
}//GEN-LAST:event_TPerujukKeyPressed

    private void TDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TDokterKeyPressed
        Valid.pindah(evt,TCari,TAlamat);
}//GEN-LAST:event_TDokterKeyPressed

    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TPerujuk.getText().trim().equals("")){
            Valid.textKosong(TPerujuk,"perujuk");
        }else if(TDokter.getText().trim().equals("")){
            Valid.textKosong(TDokter,"dokter perujuk");
        }else if(TDokter.getText().trim().equals("")){
            Valid.textKosong(TAlamat,"alamat");
        }else{
            if(Sequel.menyimpantf("master_rujuk_masuk","?,?,?,?,?","Perujuk",5,new String[]{"0",TPerujuk.getText(),TDokter.getText(),TAlamat.getText(),"1"})==true){
                tampil();
                emptTeks();
            }else{
                TPerujuk.requestFocus();
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,TDokter,BtnBatal);
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbBangsal.getRowCount();i++){ 
            if(tbBangsal.getValueAt(i,0).toString().equals("true")){
                Sequel.mengedit("master_rujuk_masuk","id='"+tbBangsal.getValueAt(i,1).toString()+"'","status='0'");
            }
        } 
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TPerujuk.getText().trim().equals("")){
            ...
            if(tbBangsal.getSelectedRow()>-1){
                Sequel.mengedit("master_rujuk_masuk","id=?","perujuk=?,dokter_perujuk=?,alamat=?",4,new String[]{TPerujuk.getText(),TDokter.getText(),TAlamat.getText(),tbBangsal.getValueAt(tbBangsal.getSelectedRow(), 1).toString()});
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            BtnBatal.requestFocus();
                ...
                Valid.MyReport("rptBangsal.jrxml",param,"::[ Laporan Data Rujuk Masuk ]::");
        }
    ...
    private void BtnAllKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnAllKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt, BtnCari, TPerujuk);
        }
    ...
    private void MnRestoreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRestoreActionPerformed
        DlgRestoreRujukMasuk restore=new DlgRestoreRujukMasuk(null,true);
...
//    }
    ...
    private widget.TextBox TPerujuk;
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from master_rujuk_masuk where status='1' and (perujuk like ? "+
                    "or dokter_perujuk like ? or alamat like ?) order by perujuk");
            try {
    ...
    public void emptTeks() {
        ...
        TCari.setText("");
        TPerujuk.requestFocus();
//        Valid.autoNomer(" bangsal ","B",4,TPerujuk);
    }

    private void getData() {
        if(tbBangsal.getSelectedRow()!= -1){
            TPerujuk.setText(tbBangsal.getValueAt(tbBangsal.getSelectedRow(),2).toString());
            TDokter.setText(tbBangsal.getValueAt(tbBangsal.getSelectedRow(),3).toString());
            TAlamat.setText(tbBangsal.getValueAt(tbBangsal.getSelectedRow(),4).toString());
        }
    }
