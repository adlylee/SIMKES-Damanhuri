...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    private String Suspen_Piutang_Tindakan_Ranap = "", Tindakan_Ranap = "", Beban_Jasa_Medik_Dokter_Tindakan_Ranap = "",
            ...
            Utang_KSO_Tindakan_Ranap = "", kode_poli = "", user = "";
    ...
    public DlgRawatInap(java.awt.Frame parent, boolean modal) {
        ...
        tabModePemeriksaan = new DefaultTableModel(null, new Object[]{
            ...
            "Respirasi(/menit)", "Tinggi(Cm)", "Berat(Kg)", "SPO2", "GCS(E,V,M)", "Alergi", "Subject(S)", "Object(O)",
            "Assessment(A)", "Plan(P)", "Instruksi", "Evaluasi", "Petugas", "Verified"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                boolean a = false;
                if (colIndex == 0) {
...
//                column.setMaxWidth(0);
        ...
        tbPemeriksaan.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            @Override
            public Component getTableCellRendererComponent(JTable table,
                ...
                String status = (String) table.getModel().getValueAt(row, 22);
        ...
        TSpo.setDocument(new batasInput((int) 50).getKata(TSpo));
    ...
    private void initComponents() {
        ...
        BtnKeluar5.setBounds(450, 150, 100, 30);
        ...
        scrollPane7.setViewportView(TKeterangan);

        internalFrame9.add(scrollPane7);
        scrollPane7.setBounds(74, 60, 470, 53);

        jLabel55.setText("No.Rawat :");
        jLabel55.setName("jLabel55"); // NOI18N
        jLabel55.setPreferredSize(null);
        internalFrame9.add(jLabel55);
        jLabel55.setBounds(0, 30, 70, 23);
        ...
        TNoRw1.setBounds(74, 30, 125, 23);

        TNoRM1.setEditable(false);
        TNoRM1.setHighlighter(null);
        TNoRM1.setName("TNoRM1"); // NOI18N
        internalFrame9.add(TNoRM1);
        TNoRM1.setBounds(201, 30, 80, 23);
        ...
        Scroll3.setPreferredSize(new java.awt.Dimension(402, 402));
        ...
        panelGlass12.setPreferredSize(new java.awt.Dimension(74, 134));
        panelGlass12.setLayout(null);

        jLabel7.setText("Suhu Badan(C) :");
        jLabel7.setName("jLabel7"); // NOI18N
        panelGlass12.add(jLabel7);
        jLabel7.setBounds(775, 50, 100, 23);
        ...
        TSuhu.setBounds(880, 50, 60, 23);

        jLabel4.setText("Tensi :");
        jLabel4.setName("jLabel4"); // NOI18N
        panelGlass12.add(jLabel4);
        jLabel4.setBounds(1075, 50, 50, 23);
        ...
        TTensi.setBounds(1130, 50, 60, 23);

        jLabel25.setText("Berat(Kg) :");
        jLabel25.setName("jLabel25"); // NOI18N
        panelGlass12.add(jLabel25);
        jLabel25.setBounds(935, 20, 79, 23);
        ...
        TBerat.setBounds(1020, 20, 60, 23);
        ...
        TNadi.setBounds(1020, 50, 60, 23);

        jLabel24.setText("Nadi(/menit) :");
        jLabel24.setName("jLabel24"); // NOI18N
        panelGlass12.add(jLabel24);
        jLabel24.setBounds(935, 50, 79, 23);
        ...
        TAlergi.setBounds(1130, 80, 60, 23);

        jLabel23.setText("Respirasi(/menit) :");
        jLabel23.setName("jLabel23"); // NOI18N
        panelGlass12.add(jLabel23);
        jLabel23.setBounds(775, 20, 100, 23);
        ...
        TRespirasi.setBounds(880, 20, 60, 23);

        jLabel22.setText("GCS(E,V,M) :");
        jLabel22.setName("jLabel22"); // NOI18N
        panelGlass12.add(jLabel22);
        jLabel22.setBounds(935, 80, 80, 23);
        ...
        scrollPane1.setBounds(55, 10, 190, 53);
        ...
        scrollPane2.setBounds(55, 70, 190, 53);

        jLabel8.setText("Subject :");
        jLabel8.setName("jLabel8"); // NOI18N
        panelGlass12.add(jLabel8);
        jLabel8.setBounds(0, 10, 50, 23);

        jLabel9.setText("Object :");
        jLabel9.setName("jLabel9"); // NOI18N
        panelGlass12.add(jLabel9);
        jLabel9.setBounds(0, 70, 50, 23);

        jLabel17.setText("Assesment :");
        jLabel17.setName("jLabel17"); // NOI18N
        panelGlass12.add(jLabel17);
        jLabel17.setBounds(245, 10, 70, 23);

        jLabel26.setText("Plan :");
        jLabel26.setName("jLabel26"); // NOI18N
        panelGlass12.add(jLabel26);
        jLabel26.setBounds(245, 70, 70, 23);
        ...
        scrollPane3.setBounds(320, 10, 190, 53);

        scrollPane4.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane4.setName("scrollPane4"); // NOI18N

        TRtl.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        TRtl.setColumns(20);
        TRtl.setRows(5);
        TRtl.setName("TRtl"); // NOI18N
        TRtl.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TRtlKeyPressed(evt);
            }
        });
        scrollPane4.setViewportView(TRtl);

        panelGlass12.add(scrollPane4);
        scrollPane4.setBounds(320, 70, 190, 53);

        jLabel37.setText("Instruksi :");
        jLabel37.setName("jLabel37"); // NOI18N
        panelGlass12.add(jLabel37);
        jLabel37.setBounds(505, 10, 70, 23);

        jLabel41.setText("Evaluasi :");
        jLabel41.setName("jLabel41"); // NOI18N
        panelGlass12.add(jLabel41);
        jLabel41.setBounds(505, 70, 70, 23);
        ...
        scrollPane5.setBounds(580, 10, 190, 53);
        ...
        scrollPane6.setBounds(580, 70, 190, 53);

        jLabel53.setText("SPO2 :");
        jLabel53.setName("jLabel53"); // NOI18N
        panelGlass12.add(jLabel53);
        jLabel53.setBounds(1075, 20, 50, 23);

        TSpo.setHighlighter(null);
        ...
        BtnSHKBayi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnSHKBayi.setText("Input SHK");
        BtnSHKBayi.setFocusPainted(false);
        BtnSHKBayi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnSHKBayi.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnSHKBayi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnSHKBayi.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnSHKBayi.setName("BtnSHKBayi"); // NOI18N
        BtnSHKBayi.setPreferredSize(new java.awt.Dimension(120, 23));
        BtnSHKBayi.setRoundRect(false);
        BtnSHKBayi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSHKBayiActionPerformed(evt);
            }
        });
        FormMenu.add(BtnSHKBayi);
        ...
        switch (TabRawat.getSelectedIndex()) {
            ...
            case 3:
                if (tabModePemeriksaan.getRowCount() == 0) {
                    ...
                    int reply = JOptionPane.showConfirmDialog(rootPane, "Eeiiiiiits, Yakin ingin menghapus data..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
                    if (reply == JOptionPane.YES_OPTION) {
...
//                perawatan2.tampil2();
    ...
    private void BtnSKDPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSKDPActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            ...
            form.setNoRm(TNoRM.getText(), TPasien.getText(), kode_poli, Sequel.cariIsi("select nm_poli from poliklinik where kd_poli=?", kode_poli), KdDok.getText(), TDokter.getText(), TNoRw.getText(), "Ranap");
    ...
    private void TRtlKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TRtlKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TRtlKeyPressed
    ...
    private void BtnSHKBayiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSHKBayiActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu pasien...!!!");
            TCari.requestFocus();
        } else {
            ...
            TKeterangan.setText(Sequel.cariIsi("SELECT IFNULL(keterangan,'') from shk_bayi where no_rawat=?",TNoRw1.getText()));
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            WindowInput.setLocationRelativeTo(internalFrame1);
            WindowInput.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
        }
    }//GEN-LAST:event_BtnSHKBayiActionPerformed
    ...
    private void BtnSimpan8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan8ActionPerformed
        if (TNoRw1.getText().trim().equals("")) {
            ...
            if (Sequel.menyimpantf("shk_bayi", "?,?", "No. Rawat", 2, new String[]{
                TNoRw1.getText(), TKeterangan.getText()
            }) == true) {
                JOptionPane.showMessageDialog(null, "Berhasil Simpan SHK..!!");
                WindowInput.dispose();
            }
        }       
    ...
    private widget.Button BtnSHKBayi;
    ...
    private void tampilPemeriksaan() {
        ...
        try {
            ps4 = koneksi.prepareStatement("select pemeriksaan_ranap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"
                    + "pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat,pemeriksaan_ranap.suhu_tubuh,pemeriksaan_ranap.tensi, "
                    + "pemeriksaan_ranap.nadi,pemeriksaan_ranap.respirasi,pemeriksaan_ranap.tinggi, "
                    + "pemeriksaan_ranap.berat,pemeriksaan_ranap.spo2,pemeriksaan_ranap.gcs,pemeriksaan_ranap.alergi,pemeriksaan_ranap.keluhan, "
                    + "pemeriksaan_ranap.pemeriksaan, "
                    + "pemeriksaan_ranap.penilaian,pemeriksaan_ranap.rtl,pemeriksaan_ranap.instruksi,pemeriksaan_ranap.evaluasi,petugas.nama,"
                    + "CASE WHEN pemeriksaan_ranap.verified_at IS NOT NULL THEN 'Verified' ELSE 'Not Verified' END AS verified_at "
                    + "from pasien join reg_periksa ON reg_periksa.no_rkm_medis=pasien.no_rkm_medis join pemeriksaan_ranap on pemeriksaan_ranap.no_rawat=reg_periksa.no_rawat "
                    + "LEFT JOIN petugas ON pemeriksaan_ranap.nip = petugas.nip where "
                    ...
                    + " pemeriksaan_ranap.pemeriksaan like ? ) "
            ...
            try {
                ...
                while (rs.next()) {
                    tabModePemeriksaan.addRow(new Object[]{false, rs.getString(1),
                        ...
                        rs.getString(13),
                        rs.getString(14),
                        rs.getString(15), rs.getString(16), rs.getString(17), rs.getString(18), rs.getString(19), rs.getString(20), rs.getString(21), rs.getString(22)
                    });
                }
            } catch (Exception e) {
                System.out.println("Notifikasi : " + e);
    ...
    private void getDataPemeriksaan() {
        if (tbPemeriksaan.getSelectedRow() != -1) {
            ...
            TSpo.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 12).toString());
            ...
            TRtl.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 18).toString());
            TInstruksi.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 19).toString());
            TEvaluasi.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 20).toString());
    ...
    private void isLog(String action, String tanggal, String jam, String norawat) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                dataJson.addProperty("spo2", rs.getString("spo2"));
                ...
                dataJson.addProperty("instruksi", rs.getString("instruksi"));
                dataJson.addProperty("nip", rs.getString("nip"));
                dataJson.addProperty("verified_at", rs.getString("verified_at"));
        ...
        Sequel.menyimpan("mlite_log", "null,'" + var.getkode() + "','pemeriksaan_ranap','" + requestJson + "','" + dtf.format(now) + "'");
    }
}
