...
//                column.setMaxWidth(0);
    ...
    private void initComponents() {
        ...
        TNmPrw.setBounds(210, 30, 605, 23);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-04-2022" }));
            ...
            case 3:
                if (tabModePemeriksaan.getRowCount() == 0) {
                    ...
                    Valid.MyReport("rptInapPemeriksaan.jrxml", "report", "::[ Data Pemeriksaan Rawat Inap ]::",
                            ...
                            + "pemeriksaan_ranap.instruksi, pemeriksaan_ranap.evaluasi from pasien inner join reg_periksa inner join pemeriksaan_ranap "
