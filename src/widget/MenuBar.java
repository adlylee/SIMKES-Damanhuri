...
public class MenuBar extends JMenuBar {
    ...
    private final Color light = new Color(1F, 1F, 0.5F, 0.35F);
    private final Color dark = new Color(1F, 1F, 0.5F, 0.35F);
    //private Color black = Color.black;
    //private Color warna = Color.magenta.darker().darker().darker().darker();
    private final Color black = new Color(50,80,70);
    private final Color warna = new Color(204,255,102);
