 ...
 * @author perpustakaan
 */
public class DlgSetPenjabBNM extends javax.swing.JDialog {
    private final DefaultTableModel tabMode;
    private Connection koneksi=koneksiDB.condb();
    private sekuel Sequel=new sekuel();
    private validasi Valid=new validasi();
    public  DlgCariJenisIPSRS dokter=new DlgCariJenisIPSRS(null,false);
     ...
     * @param parent
     * @param modal */
    public DlgSetPenjabBNM(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,10);
        setSize(457,249);

        Object[] row={"NIP","Nama","Kode Jenis Barang","Jenis Barang"};
        ...
        petugas.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(petugas.getTable().getSelectedRow()!= -1){                    
                    ...
                    TDokter.setText(petugas.getTable().getValueAt(petugas.getTable().getSelectedRow(),1).toString());
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Setup Penanggung Jawab Barang Non Medis ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(70, 70, 70))); // NOI18N
        ...
        panelGlass7.setPreferredSize(new java.awt.Dimension(44, 85));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TDokter.getText().trim().equals("")||kddokter.getText().trim().equals("")){
            Valid.textKosong(kddokter,"Penanggung Jawab Barang");
        }else if(TDokter2.getText().trim().equals("")||kddokter2.getText().trim().equals("")){
            Valid.textKosong(kddokter2,"Barang Yang Dipilih");
        }else{
            Sequel.menyimpan("ipsrs_setpj","?,?,?","Penanggung Jawab",3,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(kddokter2.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, data yang mau dihapus tidak ada...!!!!");
            kddokter.requestFocus();
        }else{
            Sequel.mengedit("ipsrs_setpj","kd_jenis='"+kddokter2.getText()+"'","status='0'");
            tampil();
            emptTeks();
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgSetPenjabBNM dialog = new DlgSetPenjabBNM(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ResultSet rs=koneksi.prepareStatement("select * from ipsrs_setpj WHERE status = 1").executeQuery();
            while(rs.next()){
                tabMode.addRow(new Object[]{
                    rs.getString(1),Sequel.cariIsi("select nama from pegawai where nik=?",rs.getString(1)),
                    rs.getString(2),Sequel.cariIsi("select nm_jenis from ipsrsjenisbarang where kd_jenis=?",rs.getString(2))
                });
            }
    ...
    private void getData() {
        ...
        if(row!= -1){
            kddokter.setText(tbAdmin.getValueAt(row,0).toString());
            kddokter2.setText(tbAdmin.getValueAt(row,2).toString());
            TDokter.setText(tbAdmin.getValueAt(row,1).toString());
            TDokter2.setText(tbAdmin.getValueAt(row,3).toString());
        }
    }
