 ...
 * @author perpustakaan
 */
public class DlgSetUtd extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgSetUtd(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Komponen Darah :");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TDokter.getText().trim().equals("")||kddokter.getText().trim().equals("")){
            Valid.textKosong(kddokter,"Kode Lab");
        }else if(TDokter2.getText().trim().equals("")||kddokter2.getText().trim().equals("")){
            Valid.textKosong(kddokter2,"Komponen");
        }else{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgSetUtd dialog = new DlgSetUtd(new javax.swing.JFrame(), true);
