...
public final class SisruteCekReferensiKriteriaRujukan extends javax.swing.JDialog {
    ...
    private String URL="",link="",idrs="",diagnosaCari="";
    ...
    public SisruteCekReferensiKriteriaRujukan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new String[]{"No.","Kode","Deskripsi","Keterangan"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi Pelayanan Sisrute ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(70, 70, 70))); // NOI18N
    ...
    */
    ...
    public void tampil(String faskes) {
        try {
            ...
            URL = link+"/referensi/kriteria/rujukan?DIAGNOSA="+diagnosaCari;
                ...
                if(response.isArray()){
                    ...
                    for(JsonNode list:response){
                        if(list.path("KODE").asText().toLowerCase().contains(faskes.toLowerCase())|| 
                                ...
                                list.path("KET").asText().toLowerCase().contains(faskes.toLowerCase())){
                            tabMode.addRow(new Object[]{
                                i+".",list.path("KODE").asText(),list.path("DESKRIPSI").asText(),list.path("KET").asText()
                            });
                        }
                        i++;
                    }
    ...
    public void SetData(String diagnosis){
        diagnosaCari = diagnosis;
    }
}
