...
public class DlgSKDPBPJS extends javax.swing.JDialog {
    ...
    private String URUTNOREG = "", status = "", kdpoli = "", nmpoli = "", noantri = "", antrian = "", user = "", nosep = "" , nosepCari="";
    ...
    private void initComponents() {
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-01-2022" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-01-2022" }));
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-01-2022" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-01-2022" }));
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-01-2022 11:39:38" }));
        ...
        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-01-2022 11:39:39" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if (TNoRM.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            if (!nomer.equals("")) {
                System.out.println("Simpan Surat Kontrol BPJS Berhasil");
                System.out.println("Menyimpan SKDP .........");
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
    ...
    public void setNoRm(String norm, String nama, String kodepoli, String namapoli, String kodedokter, String namadokter, String norawat,String status_rawat) {
        TNoRM.setText(norm);
        TPasien.setText(nama);
        Diagnosa.setText(Sequel.cariIsi("SELECT penyakit.nm_penyakit FROM diagnosa_pasien JOIN penyakit ON diagnosa_pasien.kd_penyakit = penyakit.kd_penyakit WHERE no_rawat=? AND diagnosa_pasien.status='"+status_rawat+"' AND prioritas='1' LIMIT 1", norawat));
