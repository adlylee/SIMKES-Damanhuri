...
public final class BPJSCekReferensiPoliHfis extends javax.swing.JDialog {
    ...
    public BPJSCekReferensiPoliHfis(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Nama Poli", "Nama SubPoli", "Kode SubPoli", "Kode Poli"}) {
            @Override
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi Poli/Unit HFIS ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(70, 70, 70))); // NOI18N
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {
                        if(list.path("nmpoli").asText().toLowerCase().contains(poli.toLowerCase())||
                            ...
                            i + ".", list.path("nmpoli").asText(), list.path("nmsubspesialis").asText(), list.path("kdsubspesialis").asText(), list.path("kdpoli").asText()
                        });
                        }
                        i++;
                    }
