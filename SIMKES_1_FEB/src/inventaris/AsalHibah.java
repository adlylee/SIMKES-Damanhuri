...
public class AsalHibah extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public AsalHibah(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptAsalHibah.jasper","report","::[ Data Pemberi Hibah/Asal Hibah ]::","select pemberihibah.kode_pemberi, pemberihibah.nama_pemberi, "+
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            AsalHibah dialog = new AsalHibah(new javax.swing.JFrame(), true);
