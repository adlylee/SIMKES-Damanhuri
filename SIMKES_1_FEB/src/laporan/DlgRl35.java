...
public final class DlgRl35 extends javax.swing.JDialog {
    ...
    public DlgRl35(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr={"No.","No Rekam Medis","Alamat","Jenis Pelayanan","Rujukan","Non Rujukan","Dirawat","Dirujuk","Pulang","Mati di IGD","Doa"};
        ...
        try {
            ps=koneksi.prepareStatement("SELECT kategori FROM kategori_pasien_igd GROUP BY kategori");
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        internalFrame1.getAccessibleContext().setAccessibleName("::[ RL 3.5 Obgyn ]::");
